...
func (m AlertGetResponse) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.AlertResponse)
	if err != nil {
		return nil, err
	}
...
func (m *AlertGetResponse) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with AlertResponse
	if err := m.AlertResponse.Validate(formats); err != nil {
		res = append(res, err)
	}
