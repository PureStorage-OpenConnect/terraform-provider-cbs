...
func (m *SoftwareInstallationStepsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SoftwareInstallationStepsResponse) validateItems(formats strfmt.Registry) error {
...
func (m *SoftwareInstallationStepsResponse) UnmarshalBinary(b []byte) error {
	var res SoftwareInstallationStepsResponse
