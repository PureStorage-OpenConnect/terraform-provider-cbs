...
func (m *AdminAPITokenGetResponse) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 AdminAPITokenResponse
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.AdminAPITokenResponse = aO1
...
func (m AdminAPITokenGetResponse) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.AdminAPITokenResponse)
	if err != nil {
		return nil, err
	}
...
func (m *AdminAPITokenGetResponse) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with AdminAPITokenResponse
	if err := m.AdminAPITokenResponse.Validate(formats); err != nil {
		res = append(res, err)
	}
...
func (m *AdminAPITokenGetResponse) UnmarshalBinary(b []byte) error {
	var res AdminAPITokenGetResponse
