...
func (m EulaGetResponse) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.EulaResponse)
	if err != nil {
		return nil, err
	}
...
func (m *EulaGetResponse) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with EulaResponse
	if err := m.EulaResponse.Validate(formats); err != nil {
		res = append(res, err)
	}
