...
func (m *RemoteVolumeSnapshotTransferGetResponseAllOf2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RemoteVolumeSnapshotTransferGetResponseAllOf2) validateTotal(formats strfmt.Registry) error {
...
func (m *RemoteVolumeSnapshotTransferGetResponseAllOf2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *RemoteVolumeSnapshotTransferGetResponseAllOf2) UnmarshalBinary(b []byte) error {
	var res RemoteVolumeSnapshotTransferGetResponseAllOf2
