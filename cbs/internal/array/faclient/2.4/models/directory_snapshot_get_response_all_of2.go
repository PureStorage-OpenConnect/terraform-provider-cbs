...
func (m *DirectorySnapshotGetResponseAllOf2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DirectorySnapshotGetResponseAllOf2) validateTotal(formats strfmt.Registry) error {
...
func (m *DirectorySnapshotGetResponseAllOf2) UnmarshalBinary(b []byte) error {
	var res DirectorySnapshotGetResponseAllOf2
