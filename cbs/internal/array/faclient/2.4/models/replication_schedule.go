...
func (m *ReplicationSchedule) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 ReplicationScheduleAllOf1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.ReplicationScheduleAllOf1 = aO1
...
func (m ReplicationSchedule) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.ReplicationScheduleAllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *ReplicationSchedule) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with ReplicationScheduleAllOf1
	if err := m.ReplicationScheduleAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
