...
func (m *ArrayConnectionPathGetResponse) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 ArrayConnectionPathResponse
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.ArrayConnectionPathResponse = aO1
...
func (m ArrayConnectionPathGetResponse) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.ArrayConnectionPathResponse)
	if err != nil {
		return nil, err
	}
...
func (m *ArrayConnectionPathGetResponse) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with ArrayConnectionPathResponse
	if err := m.ArrayConnectionPathResponse.Validate(formats); err != nil {
		res = append(res, err)
	}
...
func (m *ArrayConnectionPathGetResponse) UnmarshalBinary(b []byte) error {
	var res ArrayConnectionPathGetResponse
