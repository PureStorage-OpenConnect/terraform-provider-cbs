...
func (m *ProtectionGroupSnapshotTransferResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ProtectionGroupSnapshotTransferResponse) validateItems(formats strfmt.Registry) error {
...
func (m *ProtectionGroupSnapshotTransferResponse) UnmarshalBinary(b []byte) error {
	var res ProtectionGroupSnapshotTransferResponse
