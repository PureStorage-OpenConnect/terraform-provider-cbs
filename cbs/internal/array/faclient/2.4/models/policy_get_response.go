...
func (m *PolicyGetResponse) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 PolicyResponse
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.PolicyResponse = aO1
...
func (m PolicyGetResponse) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.PolicyResponse)
	if err != nil {
		return nil, err
	}
...
func (m *PolicyGetResponse) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with PolicyResponse
	if err := m.PolicyResponse.Validate(formats); err != nil {
		res = append(res, err)
	}
