...
func (m *NetworkInterfacePerformance) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 NetworkInterfacePerformanceOAIGenAllOf1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.NetworkInterfacePerformanceOAIGenAllOf1 = aO1
...
func (m NetworkInterfacePerformance) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.NetworkInterfacePerformanceOAIGenAllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *NetworkInterfacePerformance) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with NetworkInterfacePerformanceOAIGenAllOf1
	if err := m.NetworkInterfacePerformanceOAIGenAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
...
func (m *NetworkInterfacePerformance) UnmarshalBinary(b []byte) error {
	var res NetworkInterfacePerformance
