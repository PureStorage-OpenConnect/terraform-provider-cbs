...
func (m *TargetProtectionGroup) UnmarshalJSON(raw []byte) error {
	// AO0
	var aO0 TargetProtectionGroupAllOf0
	if err := swag.ReadJSON(raw, &aO0); err != nil {
		return err
	}
	m.TargetProtectionGroupAllOf0 = aO0
...
func (m TargetProtectionGroup) MarshalJSON() ([]byte, error) {
	...
	aO0, err := swag.WriteJSON(m.TargetProtectionGroupAllOf0)
	if err != nil {
		return nil, err
	}
...
func (m *TargetProtectionGroup) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with TargetProtectionGroupAllOf0
	if err := m.TargetProtectionGroupAllOf0.Validate(formats); err != nil {
		res = append(res, err)
	}
