...
func (m *ResourcePerformanceNoIDGetResponse) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 ResourcePerformanceNoIDGetResponseAllOf1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.ResourcePerformanceNoIDGetResponseAllOf1 = aO1
...
func (m ResourcePerformanceNoIDGetResponse) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.ResourcePerformanceNoIDGetResponseAllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *ResourcePerformanceNoIDGetResponse) Validate(formats strfmt.Registry) error {
	var res []error
	...
	// validation for a type composition with ResourcePerformanceNoIDGetResponseAllOf1
	if err := m.ResourcePerformanceNoIDGetResponseAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
...
func (m *ResourcePerformanceNoIDGetResponse) UnmarshalBinary(b []byte) error {
	var res ResourcePerformanceNoIDGetResponse
