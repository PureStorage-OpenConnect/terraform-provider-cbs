...
func (m *MemberNoIDAll) UnmarshalJSON(raw []byte) error {
	// AO0
	var aO0 MemberNoIDAllOAIGenAllOf0
	if err := swag.ReadJSON(raw, &aO0); err != nil {
		return err
	}
	m.MemberNoIDAllOAIGenAllOf0 = aO0
...
func (m MemberNoIDAll) MarshalJSON() ([]byte, error) {
	...
	aO0, err := swag.WriteJSON(m.MemberNoIDAllOAIGenAllOf0)
	if err != nil {
		return nil, err
	}
...
func (m *MemberNoIDAll) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with MemberNoIDAllOAIGenAllOf0
	if err := m.MemberNoIDAllOAIGenAllOf0.Validate(formats); err != nil {
		res = append(res, err)
	}
