...
func (m *NetworkInterfacePost) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 NetworkInterfacePostAllOf1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.NetworkInterfacePostAllOf1 = aO1
...
func (m NetworkInterfacePost) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.NetworkInterfacePostAllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *NetworkInterfacePost) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with NetworkInterfacePostAllOf1
	if err := m.NetworkInterfacePostAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
