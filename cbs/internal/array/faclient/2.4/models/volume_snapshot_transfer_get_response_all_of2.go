...
func (m *VolumeSnapshotTransferGetResponseAllOf2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *VolumeSnapshotTransferGetResponseAllOf2) validateTotal(formats strfmt.Registry) error {
...
func (m *VolumeSnapshotTransferGetResponseAllOf2) UnmarshalBinary(b []byte) error {
	var res VolumeSnapshotTransferGetResponseAllOf2
