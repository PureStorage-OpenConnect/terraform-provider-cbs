...
func (m *NetworkInterfacePatch) UnmarshalJSON(raw []byte) error {
	// AO0
	var aO0 NetworkInterfacePatchAllOf0
	if err := swag.ReadJSON(raw, &aO0); err != nil {
		return err
	}
	m.NetworkInterfacePatchAllOf0 = aO0
...
func (m NetworkInterfacePatch) MarshalJSON() ([]byte, error) {
	...
	aO0, err := swag.WriteJSON(m.NetworkInterfacePatchAllOf0)
	if err != nil {
		return nil, err
	}
...
func (m *NetworkInterfacePatch) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with NetworkInterfacePatchAllOf0
	if err := m.NetworkInterfacePatchAllOf0.Validate(formats); err != nil {
		res = append(res, err)
	}
