...
func (m *DirectoryServiceGetResponse) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 DirectoryServiceResponse
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.DirectoryServiceResponse = aO1
...
func (m DirectoryServiceGetResponse) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.DirectoryServiceResponse)
	if err != nil {
		return nil, err
	}
...
func (m *DirectoryServiceGetResponse) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with DirectoryServiceResponse
	if err := m.DirectoryServiceResponse.Validate(formats); err != nil {
		res = append(res, err)
	}
...
func (m *DirectoryServiceGetResponse) UnmarshalBinary(b []byte) error {
	var res DirectoryServiceGetResponse
