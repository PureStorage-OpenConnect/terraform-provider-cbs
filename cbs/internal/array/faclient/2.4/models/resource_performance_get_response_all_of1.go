...
func (m *ResourcePerformanceGetResponseAllOf1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResourcePerformanceGetResponseAllOf1) validateItems(formats strfmt.Registry) error {
...
func (m *ResourcePerformanceGetResponseAllOf1) validateTotal(formats strfmt.Registry) error {
...
func (m *ResourcePerformanceGetResponseAllOf1) UnmarshalBinary(b []byte) error {
	var res ResourcePerformanceGetResponseAllOf1
