...
func (m *ResourcePodSpaceGetResponse) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 ResourcePodSpaceGetResponseAllOf1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.ResourcePodSpaceGetResponseAllOf1 = aO1
...
func (m ResourcePodSpaceGetResponse) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.ResourcePodSpaceGetResponseAllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *ResourcePodSpaceGetResponse) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with ResourcePodSpaceGetResponseAllOf1
	if err := m.ResourcePodSpaceGetResponseAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
...
func (m *ResourcePodSpaceGetResponse) UnmarshalBinary(b []byte) error {
	var res ResourcePodSpaceGetResponse
