...
func (m *SoftwareGetResponse) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 SoftwareResponse
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.SoftwareResponse = aO1
...
func (m SoftwareGetResponse) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.SoftwareResponse)
	if err != nil {
		return nil, err
	}
...
func (m *SoftwareGetResponse) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with SoftwareResponse
	if err := m.SoftwareResponse.Validate(formats); err != nil {
		res = append(res, err)
	}
