...
func (m HostGetResponse) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.HostResponse)
	if err != nil {
		return nil, err
	}
...
func (m *HostGetResponse) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with HostResponse
	if err := m.HostResponse.Validate(formats); err != nil {
		res = append(res, err)
	}
