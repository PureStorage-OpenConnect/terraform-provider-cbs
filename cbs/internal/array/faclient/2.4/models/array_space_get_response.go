...
func (m *ArraySpaceGetResponse) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 ArraySpaceGetResponseAllOf1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.ArraySpaceGetResponseAllOf1 = aO1
...
func (m ArraySpaceGetResponse) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.ArraySpaceGetResponseAllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *ArraySpaceGetResponse) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with ArraySpaceGetResponseAllOf1
	if err := m.ArraySpaceGetResponseAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
