...
func (m *KMIPTestResultGetResponseAllOf1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *KMIPTestResultGetResponseAllOf1) validateItems(formats strfmt.Registry) error {
...
func (m *KMIPTestResultGetResponseAllOf1) UnmarshalBinary(b []byte) error {
	var res KMIPTestResultGetResponseAllOf1
