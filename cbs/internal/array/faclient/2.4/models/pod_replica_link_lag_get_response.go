...
func (m *PodReplicaLinkLagGetResponse) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 PodReplicaLinkLagResponse
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.PodReplicaLinkLagResponse = aO1
...
func (m PodReplicaLinkLagGetResponse) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.PodReplicaLinkLagResponse)
	if err != nil {
		return nil, err
	}
...
func (m *PodReplicaLinkLagGetResponse) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with PodReplicaLinkLagResponse
	if err := m.PodReplicaLinkLagResponse.Validate(formats); err != nil {
		res = append(res, err)
	}
...
func (m *PodReplicaLinkLagGetResponse) UnmarshalBinary(b []byte) error {
	var res PodReplicaLinkLagGetResponse
