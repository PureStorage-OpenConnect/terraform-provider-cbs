...
func (m *TestResultWithResourceGetResponseAllOf1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TestResultWithResourceGetResponseAllOf1) validateItems(formats strfmt.Registry) error {
...
func (m *TestResultWithResourceGetResponseAllOf1) UnmarshalBinary(b []byte) error {
	var res TestResultWithResourceGetResponseAllOf1
