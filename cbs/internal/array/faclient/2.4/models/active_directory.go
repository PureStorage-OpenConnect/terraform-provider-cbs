...
func (m *ActiveDirectory) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 ActiveDirectoryAllOf1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.ActiveDirectoryAllOf1 = aO1
...
func (m ActiveDirectory) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.ActiveDirectoryAllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *ActiveDirectory) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with ActiveDirectoryAllOf1
	if err := m.ActiveDirectoryAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
