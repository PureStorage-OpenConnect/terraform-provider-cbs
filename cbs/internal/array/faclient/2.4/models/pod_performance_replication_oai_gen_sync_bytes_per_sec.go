...
func (m *PodPerformanceReplicationOAIGenSyncBytesPerSec) UnmarshalJSON(raw []byte) error {
	// AO0
...
func (m PodPerformanceReplicationOAIGenSyncBytesPerSec) MarshalJSON() ([]byte, error) {
...
func (m *PodPerformanceReplicationOAIGenSyncBytesPerSec) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PodPerformanceReplicationOAIGenSyncBytesPerSec) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PodPerformanceReplicationOAIGenSyncBytesPerSec) UnmarshalBinary(b []byte) error {
	var res PodPerformanceReplicationOAIGenSyncBytesPerSec
