...
func (m Arrays) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.ArraysAllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *Arrays) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with ArraysAllOf1
	if err := m.ArraysAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
