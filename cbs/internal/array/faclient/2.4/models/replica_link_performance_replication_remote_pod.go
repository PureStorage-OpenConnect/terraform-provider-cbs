...
func (m ReplicaLinkPerformanceReplicationRemotePod) MarshalJSON() ([]byte, error) {
...
func (m *ReplicaLinkPerformanceReplicationRemotePod) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ReplicaLinkPerformanceReplicationRemotePod) UnmarshalBinary(b []byte) error {
	var res ReplicaLinkPerformanceReplicationRemotePod
