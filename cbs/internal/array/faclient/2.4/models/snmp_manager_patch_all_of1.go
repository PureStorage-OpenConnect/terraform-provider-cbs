...
func (m *SNMPManagerPatchAllOf1) validateV2c(formats strfmt.Registry) error {
...
func (m *SNMPManagerPatchAllOf1) validateV3(formats strfmt.Registry) error {
...
func (m *SNMPManagerPatchAllOf1) UnmarshalBinary(b []byte) error {
	var res SNMPManagerPatchAllOf1
