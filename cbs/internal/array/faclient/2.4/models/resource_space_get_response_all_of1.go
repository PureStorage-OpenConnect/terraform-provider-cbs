...
func (m *ResourceSpaceGetResponseAllOf1) validateItems(formats strfmt.Registry) error {
...
func (m *ResourceSpaceGetResponseAllOf1) validateTotal(formats strfmt.Registry) error {
...
func (m *ResourceSpaceGetResponseAllOf1) UnmarshalBinary(b []byte) error {
	var res ResourceSpaceGetResponseAllOf1
