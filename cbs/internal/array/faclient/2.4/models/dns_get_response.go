...
func (m DNSGetResponse) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.DNSResponse)
	if err != nil {
		return nil, err
	}
...
func (m *DNSGetResponse) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with DNSResponse
	if err := m.DNSResponse.Validate(formats); err != nil {
		res = append(res, err)
	}
