...
func (m ReplicaLinkPerformanceReplicationLocalPod) MarshalJSON() ([]byte, error) {
...
func (m *ReplicaLinkPerformanceReplicationLocalPod) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ReplicaLinkPerformanceReplicationLocalPod) UnmarshalBinary(b []byte) error {
	var res ReplicaLinkPerformanceReplicationLocalPod
