...
func (m *ProtectionGroupSnapshotTransferGetResponseAllOf2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ProtectionGroupSnapshotTransferGetResponseAllOf2) validateTotal(formats strfmt.Registry) error {
...
func (m *ProtectionGroupSnapshotTransferGetResponseAllOf2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ProtectionGroupSnapshotTransferGetResponseAllOf2) UnmarshalBinary(b []byte) error {
	var res ProtectionGroupSnapshotTransferGetResponseAllOf2
