...
func (m *HardwarePatch) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 HardwarePatchAllOf1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.HardwarePatchAllOf1 = aO1
...
func (m HardwarePatch) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.HardwarePatchAllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *HardwarePatch) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with HardwarePatchAllOf1
	if err := m.HardwarePatchAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
