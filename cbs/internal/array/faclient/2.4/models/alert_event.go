...
func (m *AlertEvent) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 AlertEventOAIGenAllOf1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.AlertEventOAIGenAllOf1 = aO1
...
func (m AlertEvent) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.AlertEventOAIGenAllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *AlertEvent) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with AlertEventOAIGenAllOf1
	if err := m.AlertEventOAIGenAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
