...
// NewPostAPI24HostsParams creates a new PostAPI24HostsParams object
// with the default values initialized.
func NewPostAPI24HostsParams() *PostAPI24HostsParams {
	var ()
	return &PostAPI24HostsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostAPI24HostsParamsWithTimeout creates a new PostAPI24HostsParams object
...
// NewPostAPI24HostsParamsWithContext creates a new PostAPI24HostsParams object
...
// NewPostAPI24HostsParamsWithHTTPClient creates a new PostAPI24HostsParams object
...
/*PostAPI24HostsParams contains all the parameters to send to the API endpoint
for the post API 24 hosts operation typically these are written to a http.Request
*/
type PostAPI24HostsParams struct {
