...
func (o *PatchAPI24VolumeSnapshotsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewPatchApi24VolumeSnapshotsBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewPatchApi24VolumeSnapshotsBadRequest() *PatchApi24VolumeSnapshotsBadRequest {
	return &PatchApi24VolumeSnapshotsBadRequest{}
}
...
func (o *PatchApi24VolumeSnapshotsBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /api/2.4/volume-snapshots][%d] patchApi24VolumeSnapshotsBadRequest  %+v", 400, o.Payload)
}
...
func (o *PatchApi24VolumeSnapshotsBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
