...
func (o *PutAPI24VolumeSnapshotsTagsBatchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewPutApi24VolumeSnapshotsTagsBatchBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewPutApi24VolumeSnapshotsTagsBatchBadRequest() *PutApi24VolumeSnapshotsTagsBatchBadRequest {
	return &PutApi24VolumeSnapshotsTagsBatchBadRequest{}
}
...
func (o *PutApi24VolumeSnapshotsTagsBatchBadRequest) Error() string {
	return fmt.Sprintf("[PUT /api/2.4/volume-snapshots/tags/batch][%d] putApi24VolumeSnapshotsTagsBatchBadRequest  %+v", 400, o.Payload)
}
...
func (o *PutApi24VolumeSnapshotsTagsBatchBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
