...
func (o *PostAPI24VolumeSnapshotsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewPostApi24VolumeSnapshotsBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewPostApi24VolumeSnapshotsBadRequest() *PostApi24VolumeSnapshotsBadRequest {
	return &PostApi24VolumeSnapshotsBadRequest{}
}
...
func (o *PostApi24VolumeSnapshotsBadRequest) Error() string {
	return fmt.Sprintf("[POST /api/2.4/volume-snapshots][%d] postApi24VolumeSnapshotsBadRequest  %+v", 400, o.Payload)
}
...
func (o *PostApi24VolumeSnapshotsBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
