...
func (o *DeleteAPI24NetworkInterfacesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDeleteApi24NetworkInterfacesBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewDeleteApi24NetworkInterfacesBadRequest() *DeleteApi24NetworkInterfacesBadRequest {
	return &DeleteApi24NetworkInterfacesBadRequest{}
}
...
func (o *DeleteApi24NetworkInterfacesBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /api/2.4/network-interfaces][%d] deleteApi24NetworkInterfacesBadRequest  %+v", 400, o.Payload)
}

func (o *DeleteApi24NetworkInterfacesBadRequest) GetPayload() *models.Error {
	return o.Payload
}

func (o *DeleteApi24NetworkInterfacesBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
