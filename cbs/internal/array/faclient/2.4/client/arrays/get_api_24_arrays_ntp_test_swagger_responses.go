...
func (o *GetAPI24ArraysNtpTestReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewGetApi24ArraysNtpTestBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewGetApi24ArraysNtpTestBadRequest() *GetApi24ArraysNtpTestBadRequest {
	return &GetApi24ArraysNtpTestBadRequest{}
}
...
BadRequest
*/
type GetApi24ArraysNtpTestBadRequest struct {
	Payload *models.Error
}

func (o *GetApi24ArraysNtpTestBadRequest) Error() string {
	return fmt.Sprintf("[GET /api/2.4/arrays/ntp-test][%d] getApi24ArraysNtpTestBadRequest  %+v", 400, o.Payload)
}
...
func (o *GetApi24ArraysNtpTestBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
