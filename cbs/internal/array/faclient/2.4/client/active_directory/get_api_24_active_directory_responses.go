...
func (o *GetAPI24ActiveDirectoryReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewGetApi24ActiveDirectoryBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewGetApi24ActiveDirectoryBadRequest() *GetApi24ActiveDirectoryBadRequest {
	return &GetApi24ActiveDirectoryBadRequest{}
}
...
func (o *GetApi24ActiveDirectoryBadRequest) Error() string {
	return fmt.Sprintf("[GET /api/2.4/active-directory][%d] getApi24ActiveDirectoryBadRequest  %+v", 400, o.Payload)
}

func (o *GetApi24ActiveDirectoryBadRequest) GetPayload() *models.Error {
	return o.Payload
}

func (o *GetApi24ActiveDirectoryBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
