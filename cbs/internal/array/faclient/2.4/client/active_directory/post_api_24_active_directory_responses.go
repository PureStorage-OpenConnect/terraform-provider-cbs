...
func (o *PostAPI24ActiveDirectoryReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewPostApi24ActiveDirectoryBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewPostApi24ActiveDirectoryBadRequest() *PostApi24ActiveDirectoryBadRequest {
	return &PostApi24ActiveDirectoryBadRequest{}
}
...
func (o *PostApi24ActiveDirectoryBadRequest) Error() string {
	return fmt.Sprintf("[POST /api/2.4/active-directory][%d] postApi24ActiveDirectoryBadRequest  %+v", 400, o.Payload)
}

func (o *PostApi24ActiveDirectoryBadRequest) GetPayload() *models.Error {
	return o.Payload
}

func (o *PostApi24ActiveDirectoryBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
