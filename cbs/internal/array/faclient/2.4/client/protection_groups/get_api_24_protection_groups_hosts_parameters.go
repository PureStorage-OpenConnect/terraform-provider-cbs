...
// NewGetAPI24ProtectionGroupsHostsParams creates a new GetAPI24ProtectionGroupsHostsParams object
// with the default values initialized.
func NewGetAPI24ProtectionGroupsHostsParams() *GetAPI24ProtectionGroupsHostsParams {
	var ()
	return &GetAPI24ProtectionGroupsHostsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24ProtectionGroupsHostsParamsWithTimeout creates a new GetAPI24ProtectionGroupsHostsParams object
...
// NewGetAPI24ProtectionGroupsHostsParamsWithContext creates a new GetAPI24ProtectionGroupsHostsParams object
...
// NewGetAPI24ProtectionGroupsHostsParamsWithHTTPClient creates a new GetAPI24ProtectionGroupsHostsParams object
...
/*GetAPI24ProtectionGroupsHostsParams contains all the parameters to send to the API endpoint
for the get API 24 protection groups hosts operation typically these are written to a http.Request
*/
...
func (o *GetAPI24ProtectionGroupsHostsParams) WithTimeout(timeout time.Duration) *GetAPI24ProtectionGroupsHostsParams {
...
func (o *GetAPI24ProtectionGroupsHostsParams) WithContext(ctx context.Context) *GetAPI24ProtectionGroupsHostsParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get API 24 protection groups hosts params
func (o *GetAPI24ProtectionGroupsHostsParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get API 24 protection groups hosts params
func (o *GetAPI24ProtectionGroupsHostsParams) WithHTTPClient(client *http.Client) *GetAPI24ProtectionGroupsHostsParams {
...
func (o *GetAPI24ProtectionGroupsHostsParams) WithAuthorization(authorization *string) *GetAPI24ProtectionGroupsHostsParams {
...
func (o *GetAPI24ProtectionGroupsHostsParams) WithXRequestID(xRequestID *string) *GetAPI24ProtectionGroupsHostsParams {
...
func (o *GetAPI24ProtectionGroupsHostsParams) WithFilter(filter *string) *GetAPI24ProtectionGroupsHostsParams {
	o.SetFilter(filter)
	return o
}
...
func (o *GetAPI24ProtectionGroupsHostsParams) WithGroupNames(groupNames []string) *GetAPI24ProtectionGroupsHostsParams {
...
func (o *GetAPI24ProtectionGroupsHostsParams) WithLimit(limit *int32) *GetAPI24ProtectionGroupsHostsParams {
	o.SetLimit(limit)
	return o
}
...
func (o *GetAPI24ProtectionGroupsHostsParams) WithMemberNames(memberNames []string) *GetAPI24ProtectionGroupsHostsParams {
...
func (o *GetAPI24ProtectionGroupsHostsParams) WithOffset(offset *int32) *GetAPI24ProtectionGroupsHostsParams {
	o.SetOffset(offset)
	return o
}
...
func (o *GetAPI24ProtectionGroupsHostsParams) WithSort(sort []string) *GetAPI24ProtectionGroupsHostsParams {
	o.SetSort(sort)
	return o
}
...
func (o *GetAPI24ProtectionGroupsHostsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
