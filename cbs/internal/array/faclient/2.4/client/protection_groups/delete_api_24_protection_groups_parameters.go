...
// NewDeleteAPI24ProtectionGroupsParams creates a new DeleteAPI24ProtectionGroupsParams object
// with the default values initialized.
func NewDeleteAPI24ProtectionGroupsParams() *DeleteAPI24ProtectionGroupsParams {
	var ()
	return &DeleteAPI24ProtectionGroupsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewDeleteAPI24ProtectionGroupsParamsWithTimeout creates a new DeleteAPI24ProtectionGroupsParams object
...
// NewDeleteAPI24ProtectionGroupsParamsWithContext creates a new DeleteAPI24ProtectionGroupsParams object
...
// NewDeleteAPI24ProtectionGroupsParamsWithHTTPClient creates a new DeleteAPI24ProtectionGroupsParams object
...
/*DeleteAPI24ProtectionGroupsParams contains all the parameters to send to the API endpoint
for the delete API 24 protection groups operation typically these are written to a http.Request
*/
...
func (o *DeleteAPI24ProtectionGroupsParams) WithTimeout(timeout time.Duration) *DeleteAPI24ProtectionGroupsParams {
...
func (o *DeleteAPI24ProtectionGroupsParams) WithContext(ctx context.Context) *DeleteAPI24ProtectionGroupsParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the delete API 24 protection groups params
func (o *DeleteAPI24ProtectionGroupsParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the delete API 24 protection groups params
func (o *DeleteAPI24ProtectionGroupsParams) WithHTTPClient(client *http.Client) *DeleteAPI24ProtectionGroupsParams {
...
func (o *DeleteAPI24ProtectionGroupsParams) WithXRequestID(xRequestID *string) *DeleteAPI24ProtectionGroupsParams {
...
func (o *DeleteAPI24ProtectionGroupsParams) WithNames(names []string) *DeleteAPI24ProtectionGroupsParams {
	o.SetNames(names)
	return o
}
...
func (o *DeleteAPI24ProtectionGroupsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
