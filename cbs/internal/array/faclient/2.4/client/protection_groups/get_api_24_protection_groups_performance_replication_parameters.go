...
// NewGetAPI24ProtectionGroupsPerformanceReplicationParams creates a new GetAPI24ProtectionGroupsPerformanceReplicationParams object
// with the default values initialized.
func NewGetAPI24ProtectionGroupsPerformanceReplicationParams() *GetAPI24ProtectionGroupsPerformanceReplicationParams {
	var ()
	return &GetAPI24ProtectionGroupsPerformanceReplicationParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24ProtectionGroupsPerformanceReplicationParamsWithTimeout creates a new GetAPI24ProtectionGroupsPerformanceReplicationParams object
...
// NewGetAPI24ProtectionGroupsPerformanceReplicationParamsWithContext creates a new GetAPI24ProtectionGroupsPerformanceReplicationParams object
...
// NewGetAPI24ProtectionGroupsPerformanceReplicationParamsWithHTTPClient creates a new GetAPI24ProtectionGroupsPerformanceReplicationParams object
...
/*GetAPI24ProtectionGroupsPerformanceReplicationParams contains all the parameters to send to the API endpoint
for the get API 24 protection groups performance replication operation typically these are written to a http.Request
*/
...
func (o *GetAPI24ProtectionGroupsPerformanceReplicationParams) WithTimeout(timeout time.Duration) *GetAPI24ProtectionGroupsPerformanceReplicationParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the get API 24 protection groups performance replication params
func (o *GetAPI24ProtectionGroupsPerformanceReplicationParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the get API 24 protection groups performance replication params
func (o *GetAPI24ProtectionGroupsPerformanceReplicationParams) WithContext(ctx context.Context) *GetAPI24ProtectionGroupsPerformanceReplicationParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get API 24 protection groups performance replication params
func (o *GetAPI24ProtectionGroupsPerformanceReplicationParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get API 24 protection groups performance replication params
func (o *GetAPI24ProtectionGroupsPerformanceReplicationParams) WithHTTPClient(client *http.Client) *GetAPI24ProtectionGroupsPerformanceReplicationParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the get API 24 protection groups performance replication params
func (o *GetAPI24ProtectionGroupsPerformanceReplicationParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithAuthorization adds the authorization to the get API 24 protection groups performance replication params
func (o *GetAPI24ProtectionGroupsPerformanceReplicationParams) WithAuthorization(authorization *string) *GetAPI24ProtectionGroupsPerformanceReplicationParams {
...
func (o *GetAPI24ProtectionGroupsPerformanceReplicationParams) WithXRequestID(xRequestID *string) *GetAPI24ProtectionGroupsPerformanceReplicationParams {
...
func (o *GetAPI24ProtectionGroupsPerformanceReplicationParams) WithDestroyed(destroyed *bool) *GetAPI24ProtectionGroupsPerformanceReplicationParams {
...
func (o *GetAPI24ProtectionGroupsPerformanceReplicationParams) WithEndTime(endTime *int64) *GetAPI24ProtectionGroupsPerformanceReplicationParams {
	o.SetEndTime(endTime)
	return o
}

// SetEndTime adds the endTime to the get API 24 protection groups performance replication params
func (o *GetAPI24ProtectionGroupsPerformanceReplicationParams) SetEndTime(endTime *int64) {
	o.EndTime = endTime
}

// WithFilter adds the filter to the get API 24 protection groups performance replication params
func (o *GetAPI24ProtectionGroupsPerformanceReplicationParams) WithFilter(filter *string) *GetAPI24ProtectionGroupsPerformanceReplicationParams {
	o.SetFilter(filter)
	return o
}

// SetFilter adds the filter to the get API 24 protection groups performance replication params
func (o *GetAPI24ProtectionGroupsPerformanceReplicationParams) SetFilter(filter *string) {
	o.Filter = filter
}

// WithLimit adds the limit to the get API 24 protection groups performance replication params
func (o *GetAPI24ProtectionGroupsPerformanceReplicationParams) WithLimit(limit *int32) *GetAPI24ProtectionGroupsPerformanceReplicationParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the get API 24 protection groups performance replication params
func (o *GetAPI24ProtectionGroupsPerformanceReplicationParams) SetLimit(limit *int32) {
	o.Limit = limit
}

// WithNames adds the names to the get API 24 protection groups performance replication params
func (o *GetAPI24ProtectionGroupsPerformanceReplicationParams) WithNames(names []string) *GetAPI24ProtectionGroupsPerformanceReplicationParams {
	o.SetNames(names)
	return o
}

// SetNames adds the names to the get API 24 protection groups performance replication params
func (o *GetAPI24ProtectionGroupsPerformanceReplicationParams) SetNames(names []string) {
	o.Names = names
}

// WithOffset adds the offset to the get API 24 protection groups performance replication params
func (o *GetAPI24ProtectionGroupsPerformanceReplicationParams) WithOffset(offset *int32) *GetAPI24ProtectionGroupsPerformanceReplicationParams {
	o.SetOffset(offset)
	return o
}

// SetOffset adds the offset to the get API 24 protection groups performance replication params
func (o *GetAPI24ProtectionGroupsPerformanceReplicationParams) SetOffset(offset *int32) {
	o.Offset = offset
}

// WithResolution adds the resolution to the get API 24 protection groups performance replication params
func (o *GetAPI24ProtectionGroupsPerformanceReplicationParams) WithResolution(resolution *int64) *GetAPI24ProtectionGroupsPerformanceReplicationParams {
...
func (o *GetAPI24ProtectionGroupsPerformanceReplicationParams) WithSort(sort []string) *GetAPI24ProtectionGroupsPerformanceReplicationParams {
	o.SetSort(sort)
	return o
}

// SetSort adds the sort to the get API 24 protection groups performance replication params
func (o *GetAPI24ProtectionGroupsPerformanceReplicationParams) SetSort(sort []string) {
	o.Sort = sort
}

// WithStartTime adds the startTime to the get API 24 protection groups performance replication params
func (o *GetAPI24ProtectionGroupsPerformanceReplicationParams) WithStartTime(startTime *int64) *GetAPI24ProtectionGroupsPerformanceReplicationParams {
...
func (o *GetAPI24ProtectionGroupsPerformanceReplicationParams) WithTotalItemCount(totalItemCount *bool) *GetAPI24ProtectionGroupsPerformanceReplicationParams {
...
func (o *GetAPI24ProtectionGroupsPerformanceReplicationParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
