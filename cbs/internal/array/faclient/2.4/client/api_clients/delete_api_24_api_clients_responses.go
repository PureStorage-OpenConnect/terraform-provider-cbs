...
func (o *DeleteAPI24APIClientsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDeleteApi24APIClientsBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewDeleteApi24APIClientsBadRequest() *DeleteApi24APIClientsBadRequest {
	return &DeleteApi24APIClientsBadRequest{}
}
...
func (o *DeleteApi24APIClientsBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /api/2.4/api-clients][%d] deleteApi24ApiClientsBadRequest  %+v", 400, o.Payload)
}
...
func (o *DeleteApi24APIClientsBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
