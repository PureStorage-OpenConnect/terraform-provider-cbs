...
func (o *GetAPI24PodReplicaLinksReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewGetApi24PodReplicaLinksBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewGetApi24PodReplicaLinksBadRequest() *GetApi24PodReplicaLinksBadRequest {
	return &GetApi24PodReplicaLinksBadRequest{}
}
...
func (o *GetApi24PodReplicaLinksBadRequest) Error() string {
	return fmt.Sprintf("[GET /api/2.4/pod-replica-links][%d] getApi24PodReplicaLinksBadRequest  %+v", 400, o.Payload)
}

func (o *GetApi24PodReplicaLinksBadRequest) GetPayload() *models.Error {
	return o.Payload
}

func (o *GetApi24PodReplicaLinksBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
