...
func (o *PatchAPI24RemoteProtectionGroupSnapshotsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewPatchApi24RemoteProtectionGroupSnapshotsBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewPatchApi24RemoteProtectionGroupSnapshotsBadRequest() *PatchApi24RemoteProtectionGroupSnapshotsBadRequest {
	return &PatchApi24RemoteProtectionGroupSnapshotsBadRequest{}
}
...
func (o *PatchApi24RemoteProtectionGroupSnapshotsBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /api/2.4/remote-protection-group-snapshots][%d] patchApi24RemoteProtectionGroupSnapshotsBadRequest  %+v", 400, o.Payload)
}

func (o *PatchApi24RemoteProtectionGroupSnapshotsBadRequest) GetPayload() *models.Error {
	return o.Payload
}

func (o *PatchApi24RemoteProtectionGroupSnapshotsBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
