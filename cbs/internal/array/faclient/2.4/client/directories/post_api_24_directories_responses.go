...
func (o *PostAPI24DirectoriesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewPostApi24DirectoriesBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewPostApi24DirectoriesBadRequest() *PostApi24DirectoriesBadRequest {
	return &PostApi24DirectoriesBadRequest{}
}
...
func (o *PostApi24DirectoriesBadRequest) Error() string {
	return fmt.Sprintf("[POST /api/2.4/directories][%d] postApi24DirectoriesBadRequest  %+v", 400, o.Payload)
}
...
func (o *PostApi24DirectoriesBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
