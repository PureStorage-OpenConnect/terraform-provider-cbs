...
func (o *GetAPI24DirectoriesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewGetApi24DirectoriesBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewGetApi24DirectoriesBadRequest() *GetApi24DirectoriesBadRequest {
	return &GetApi24DirectoriesBadRequest{}
}
...
func (o *GetApi24DirectoriesBadRequest) Error() string {
	return fmt.Sprintf("[GET /api/2.4/directories][%d] getApi24DirectoriesBadRequest  %+v", 400, o.Payload)
}
...
func (o *GetApi24DirectoriesBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
