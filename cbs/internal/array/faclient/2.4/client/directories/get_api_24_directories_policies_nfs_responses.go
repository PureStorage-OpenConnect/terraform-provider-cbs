...
func (o *GetAPI24DirectoriesPoliciesNfsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewGetApi24DirectoriesPoliciesNfsBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewGetApi24DirectoriesPoliciesNfsBadRequest() *GetApi24DirectoriesPoliciesNfsBadRequest {
	return &GetApi24DirectoriesPoliciesNfsBadRequest{}
}
...
func (o *GetApi24DirectoriesPoliciesNfsBadRequest) Error() string {
	return fmt.Sprintf("[GET /api/2.4/directories/policies/nfs][%d] getApi24DirectoriesPoliciesNfsBadRequest  %+v", 400, o.Payload)
}

func (o *GetApi24DirectoriesPoliciesNfsBadRequest) GetPayload() *models.Error {
	return o.Payload
}

func (o *GetApi24DirectoriesPoliciesNfsBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
