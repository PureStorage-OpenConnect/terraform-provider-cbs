...
// NewGetAPI24DirectoriesPerformanceParams creates a new GetAPI24DirectoriesPerformanceParams object
// with the default values initialized.
func NewGetAPI24DirectoriesPerformanceParams() *GetAPI24DirectoriesPerformanceParams {
	var ()
	return &GetAPI24DirectoriesPerformanceParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24DirectoriesPerformanceParamsWithTimeout creates a new GetAPI24DirectoriesPerformanceParams object
...
// NewGetAPI24DirectoriesPerformanceParamsWithContext creates a new GetAPI24DirectoriesPerformanceParams object
...
// NewGetAPI24DirectoriesPerformanceParamsWithHTTPClient creates a new GetAPI24DirectoriesPerformanceParams object
...
/*GetAPI24DirectoriesPerformanceParams contains all the parameters to send to the API endpoint
for the get API 24 directories performance operation typically these are written to a http.Request
*/
...
func (o *GetAPI24DirectoriesPerformanceParams) WithTimeout(timeout time.Duration) *GetAPI24DirectoriesPerformanceParams {
...
func (o *GetAPI24DirectoriesPerformanceParams) WithContext(ctx context.Context) *GetAPI24DirectoriesPerformanceParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get API 24 directories performance params
func (o *GetAPI24DirectoriesPerformanceParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get API 24 directories performance params
func (o *GetAPI24DirectoriesPerformanceParams) WithHTTPClient(client *http.Client) *GetAPI24DirectoriesPerformanceParams {
...
func (o *GetAPI24DirectoriesPerformanceParams) WithAuthorization(authorization *string) *GetAPI24DirectoriesPerformanceParams {
...
func (o *GetAPI24DirectoriesPerformanceParams) WithXRequestID(xRequestID *string) *GetAPI24DirectoriesPerformanceParams {
...
func (o *GetAPI24DirectoriesPerformanceParams) WithDestroyed(destroyed *bool) *GetAPI24DirectoriesPerformanceParams {
...
func (o *GetAPI24DirectoriesPerformanceParams) WithEndTime(endTime *int64) *GetAPI24DirectoriesPerformanceParams {
...
func (o *GetAPI24DirectoriesPerformanceParams) WithFilter(filter *string) *GetAPI24DirectoriesPerformanceParams {
	o.SetFilter(filter)
	return o
}
...
func (o *GetAPI24DirectoriesPerformanceParams) WithIds(ids []string) *GetAPI24DirectoriesPerformanceParams {
	o.SetIds(ids)
	return o
}

// SetIds adds the ids to the get API 24 directories performance params
func (o *GetAPI24DirectoriesPerformanceParams) SetIds(ids []string) {
	o.Ids = ids
}

// WithLimit adds the limit to the get API 24 directories performance params
func (o *GetAPI24DirectoriesPerformanceParams) WithLimit(limit *int32) *GetAPI24DirectoriesPerformanceParams {
	o.SetLimit(limit)
	return o
}
...
func (o *GetAPI24DirectoriesPerformanceParams) WithNames(names []string) *GetAPI24DirectoriesPerformanceParams {
	o.SetNames(names)
	return o
}
...
func (o *GetAPI24DirectoriesPerformanceParams) WithOffset(offset *int32) *GetAPI24DirectoriesPerformanceParams {
	o.SetOffset(offset)
	return o
}
...
func (o *GetAPI24DirectoriesPerformanceParams) WithProtocol(protocol *string) *GetAPI24DirectoriesPerformanceParams {
...
func (o *GetAPI24DirectoriesPerformanceParams) WithProtocolGroup(protocolGroup *string) *GetAPI24DirectoriesPerformanceParams {
...
func (o *GetAPI24DirectoriesPerformanceParams) WithResolution(resolution *int64) *GetAPI24DirectoriesPerformanceParams {
...
func (o *GetAPI24DirectoriesPerformanceParams) WithSort(sort []string) *GetAPI24DirectoriesPerformanceParams {
	o.SetSort(sort)
	return o
}
...
func (o *GetAPI24DirectoriesPerformanceParams) WithStartTime(startTime *int64) *GetAPI24DirectoriesPerformanceParams {
...
func (o *GetAPI24DirectoriesPerformanceParams) WithTotalOnly(totalOnly *bool) *GetAPI24DirectoriesPerformanceParams {
...
func (o *GetAPI24DirectoriesPerformanceParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
