...
func (o *PatchAPI24AppsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewPatchApi24AppsBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewPatchApi24AppsBadRequest() *PatchApi24AppsBadRequest {
	return &PatchApi24AppsBadRequest{}
}
...
func (o *PatchApi24AppsBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /api/2.4/apps][%d] patchApi24AppsBadRequest  %+v", 400, o.Payload)
}
...
func (o *PatchApi24AppsBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
