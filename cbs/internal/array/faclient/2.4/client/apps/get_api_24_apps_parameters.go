...
// NewGetAPI24AppsParams creates a new GetAPI24AppsParams object
// with the default values initialized.
func NewGetAPI24AppsParams() *GetAPI24AppsParams {
	var ()
	return &GetAPI24AppsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24AppsParamsWithTimeout creates a new GetAPI24AppsParams object
...
// NewGetAPI24AppsParamsWithContext creates a new GetAPI24AppsParams object
...
// NewGetAPI24AppsParamsWithHTTPClient creates a new GetAPI24AppsParams object
...
/*GetAPI24AppsParams contains all the parameters to send to the API endpoint
for the get API 24 apps operation typically these are written to a http.Request
*/
...
func (o *GetAPI24AppsParams) WithContext(ctx context.Context) *GetAPI24AppsParams {
	o.SetContext(ctx)
	return o
}
