...
// NewPatchAPI24AlertWatchersParams creates a new PatchAPI24AlertWatchersParams object
// with the default values initialized.
func NewPatchAPI24AlertWatchersParams() *PatchAPI24AlertWatchersParams {
	var ()
	return &PatchAPI24AlertWatchersParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPatchAPI24AlertWatchersParamsWithTimeout creates a new PatchAPI24AlertWatchersParams object
...
// NewPatchAPI24AlertWatchersParamsWithContext creates a new PatchAPI24AlertWatchersParams object
...
// NewPatchAPI24AlertWatchersParamsWithHTTPClient creates a new PatchAPI24AlertWatchersParams object
...
/*PatchAPI24AlertWatchersParams contains all the parameters to send to the API endpoint
for the patch API 24 alert watchers operation typically these are written to a http.Request
*/
...
func (o *PatchAPI24AlertWatchersParams) WithTimeout(timeout time.Duration) *PatchAPI24AlertWatchersParams {
...
func (o *PatchAPI24AlertWatchersParams) WithContext(ctx context.Context) *PatchAPI24AlertWatchersParams {
	o.SetContext(ctx)
	return o
}
...
func (o *PatchAPI24AlertWatchersParams) WithHTTPClient(client *http.Client) *PatchAPI24AlertWatchersParams {
...
func (o *PatchAPI24AlertWatchersParams) WithAlertWatcher(alertWatcher *models.AlertWatcherPatch) *PatchAPI24AlertWatchersParams {
...
func (o *PatchAPI24AlertWatchersParams) WithNames(names []string) *PatchAPI24AlertWatchersParams {
	o.SetNames(names)
	return o
}
...
func (o *PatchAPI24AlertWatchersParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
