...
func (o *PatchAPI24SoftwareInstallationsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewPatchApi24SoftwareInstallationsBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewPatchApi24SoftwareInstallationsBadRequest() *PatchApi24SoftwareInstallationsBadRequest {
	return &PatchApi24SoftwareInstallationsBadRequest{}
}
...
func (o *PatchApi24SoftwareInstallationsBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /api/2.4/software-installations][%d] patchApi24SoftwareInstallationsBadRequest  %+v", 400, o.Payload)
}

func (o *PatchApi24SoftwareInstallationsBadRequest) GetPayload() *models.Error {
	return o.Payload
}

func (o *PatchApi24SoftwareInstallationsBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
