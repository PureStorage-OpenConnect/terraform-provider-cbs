...
// NewGetAPI24AdminsParams creates a new GetAPI24AdminsParams object
// with the default values initialized.
func NewGetAPI24AdminsParams() *GetAPI24AdminsParams {
	var ()
	return &GetAPI24AdminsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24AdminsParamsWithTimeout creates a new GetAPI24AdminsParams object
...
// NewGetAPI24AdminsParamsWithContext creates a new GetAPI24AdminsParams object
...
// NewGetAPI24AdminsParamsWithHTTPClient creates a new GetAPI24AdminsParams object
...
/*GetAPI24AdminsParams contains all the parameters to send to the API endpoint
for the get API 24 admins operation typically these are written to a http.Request
*/
...
func (o *GetAPI24AdminsParams) WithContext(ctx context.Context) *GetAPI24AdminsParams {
	o.SetContext(ctx)
	return o
}
