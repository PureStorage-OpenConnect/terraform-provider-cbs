...
// NewGetAPI24AdminsCacheParams creates a new GetAPI24AdminsCacheParams object
// with the default values initialized.
func NewGetAPI24AdminsCacheParams() *GetAPI24AdminsCacheParams {
	var ()
	return &GetAPI24AdminsCacheParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24AdminsCacheParamsWithTimeout creates a new GetAPI24AdminsCacheParams object
...
// NewGetAPI24AdminsCacheParamsWithContext creates a new GetAPI24AdminsCacheParams object
...
// NewGetAPI24AdminsCacheParamsWithHTTPClient creates a new GetAPI24AdminsCacheParams object
...
/*GetAPI24AdminsCacheParams contains all the parameters to send to the API endpoint
for the get API 24 admins cache operation typically these are written to a http.Request
*/
...
func (o *GetAPI24AdminsCacheParams) WithTimeout(timeout time.Duration) *GetAPI24AdminsCacheParams {
...
func (o *GetAPI24AdminsCacheParams) WithContext(ctx context.Context) *GetAPI24AdminsCacheParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetAPI24AdminsCacheParams) WithFilter(filter *string) *GetAPI24AdminsCacheParams {
	o.SetFilter(filter)
	return o
}
...
func (o *GetAPI24AdminsCacheParams) WithLimit(limit *int32) *GetAPI24AdminsCacheParams {
	o.SetLimit(limit)
	return o
}
...
func (o *GetAPI24AdminsCacheParams) WithNames(names []string) *GetAPI24AdminsCacheParams {
	o.SetNames(names)
	return o
}
...
func (o *GetAPI24AdminsCacheParams) WithOffset(offset *int32) *GetAPI24AdminsCacheParams {
	o.SetOffset(offset)
	return o
}
...
func (o *GetAPI24AdminsCacheParams) WithSort(sort []string) *GetAPI24AdminsCacheParams {
	o.SetSort(sort)
	return o
}
...
func (o *GetAPI24AdminsCacheParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
