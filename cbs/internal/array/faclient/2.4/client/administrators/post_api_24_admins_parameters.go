...
// NewPostAPI24AdminsParams creates a new PostAPI24AdminsParams object
// with the default values initialized.
func NewPostAPI24AdminsParams() *PostAPI24AdminsParams {
	var ()
	return &PostAPI24AdminsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostAPI24AdminsParamsWithTimeout creates a new PostAPI24AdminsParams object
...
// NewPostAPI24AdminsParamsWithContext creates a new PostAPI24AdminsParams object
...
// NewPostAPI24AdminsParamsWithHTTPClient creates a new PostAPI24AdminsParams object
...
/*PostAPI24AdminsParams contains all the parameters to send to the API endpoint
for the post API 24 admins operation typically these are written to a http.Request
*/
...
func (o *PostAPI24AdminsParams) WithContext(ctx context.Context) *PostAPI24AdminsParams {
	o.SetContext(ctx)
	return o
}
...
func (o *PostAPI24AdminsParams) WithAdmin(admin *models.AdminPost) *PostAPI24AdminsParams {
	o.SetAdmin(admin)
	return o
}
