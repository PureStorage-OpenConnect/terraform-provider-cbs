...
// NewGetAPI24HostGroupsSpaceParams creates a new GetAPI24HostGroupsSpaceParams object
// with the default values initialized.
func NewGetAPI24HostGroupsSpaceParams() *GetAPI24HostGroupsSpaceParams {
	var ()
	return &GetAPI24HostGroupsSpaceParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24HostGroupsSpaceParamsWithTimeout creates a new GetAPI24HostGroupsSpaceParams object
...
// NewGetAPI24HostGroupsSpaceParamsWithContext creates a new GetAPI24HostGroupsSpaceParams object
...
// NewGetAPI24HostGroupsSpaceParamsWithHTTPClient creates a new GetAPI24HostGroupsSpaceParams object
...
/*GetAPI24HostGroupsSpaceParams contains all the parameters to send to the API endpoint
for the get API 24 host groups space operation typically these are written to a http.Request
*/
