...
// NewDeleteAPI24HostGroupsParams creates a new DeleteAPI24HostGroupsParams object
// with the default values initialized.
func NewDeleteAPI24HostGroupsParams() *DeleteAPI24HostGroupsParams {
	var ()
	return &DeleteAPI24HostGroupsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewDeleteAPI24HostGroupsParamsWithTimeout creates a new DeleteAPI24HostGroupsParams object
...
// NewDeleteAPI24HostGroupsParamsWithContext creates a new DeleteAPI24HostGroupsParams object
...
// NewDeleteAPI24HostGroupsParamsWithHTTPClient creates a new DeleteAPI24HostGroupsParams object
...
/*DeleteAPI24HostGroupsParams contains all the parameters to send to the API endpoint
for the delete API 24 host groups operation typically these are written to a http.Request
*/
