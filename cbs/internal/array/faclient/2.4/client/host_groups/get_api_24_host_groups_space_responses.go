...
func (o *GetAPI24HostGroupsSpaceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewGetApi24HostGroupsSpaceBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *GetApi24HostGroupsSpaceBadRequest) Error() string {
	return fmt.Sprintf("[GET /api/2.4/host-groups/space][%d] getApi24HostGroupsSpaceBadRequest  %+v", 400, o.Payload)
}
...
func (o *GetApi24HostGroupsSpaceBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
