...
func (o *PatchAPI24HostGroupsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewPatchApi24HostGroupsBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewPatchApi24HostGroupsBadRequest() *PatchApi24HostGroupsBadRequest {
	return &PatchApi24HostGroupsBadRequest{}
}
...
func (o *PatchApi24HostGroupsBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /api/2.4/host-groups][%d] patchApi24HostGroupsBadRequest  %+v", 400, o.Payload)
}
...
func (o *PatchApi24HostGroupsBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
