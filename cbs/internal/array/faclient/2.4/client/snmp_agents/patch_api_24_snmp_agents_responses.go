...
func (o *PatchAPI24SNMPAgentsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewPatchApi24SNMPAgentsBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewPatchApi24SNMPAgentsBadRequest() *PatchApi24SNMPAgentsBadRequest {
	return &PatchApi24SNMPAgentsBadRequest{}
}
...
func (o *PatchApi24SNMPAgentsBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /api/2.4/snmp-agents][%d] patchApi24SnmpAgentsBadRequest  %+v", 400, o.Payload)
}
...
func (o *PatchApi24SNMPAgentsBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
