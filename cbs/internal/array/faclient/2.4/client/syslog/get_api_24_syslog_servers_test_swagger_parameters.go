...
// NewGetAPI24SyslogServersTestParams creates a new GetAPI24SyslogServersTestParams object
// with the default values initialized.
func NewGetAPI24SyslogServersTestParams() *GetAPI24SyslogServersTestParams {
	var ()
	return &GetAPI24SyslogServersTestParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24SyslogServersTestParamsWithTimeout creates a new GetAPI24SyslogServersTestParams object
...
// NewGetAPI24SyslogServersTestParamsWithContext creates a new GetAPI24SyslogServersTestParams object
...
// NewGetAPI24SyslogServersTestParamsWithHTTPClient creates a new GetAPI24SyslogServersTestParams object
...
/*GetAPI24SyslogServersTestParams contains all the parameters to send to the API endpoint
for the get API 24 syslog servers test operation typically these are written to a http.Request
*/
...
func (o *GetAPI24SyslogServersTestParams) WithTimeout(timeout time.Duration) *GetAPI24SyslogServersTestParams {
...
func (o *GetAPI24SyslogServersTestParams) WithContext(ctx context.Context) *GetAPI24SyslogServersTestParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetAPI24SyslogServersTestParams) WithHTTPClient(client *http.Client) *GetAPI24SyslogServersTestParams {
...
func (o *GetAPI24SyslogServersTestParams) WithXRequestID(xRequestID *string) *GetAPI24SyslogServersTestParams {
...
func (o *GetAPI24SyslogServersTestParams) WithFilter(filter *string) *GetAPI24SyslogServersTestParams {
	o.SetFilter(filter)
	return o
}
...
func (o *GetAPI24SyslogServersTestParams) WithLimit(limit *int32) *GetAPI24SyslogServersTestParams {
	o.SetLimit(limit)
	return o
}
...
func (o *GetAPI24SyslogServersTestParams) WithOffset(offset *int32) *GetAPI24SyslogServersTestParams {
	o.SetOffset(offset)
	return o
}
...
func (o *GetAPI24SyslogServersTestParams) WithSort(sort []string) *GetAPI24SyslogServersTestParams {
	o.SetSort(sort)
	return o
}
...
func (o *GetAPI24SyslogServersTestParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
