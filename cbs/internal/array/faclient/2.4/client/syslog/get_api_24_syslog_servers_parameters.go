...
// NewGetAPI24SyslogServersParams creates a new GetAPI24SyslogServersParams object
// with the default values initialized.
func NewGetAPI24SyslogServersParams() *GetAPI24SyslogServersParams {
	var ()
	return &GetAPI24SyslogServersParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24SyslogServersParamsWithTimeout creates a new GetAPI24SyslogServersParams object
...
// NewGetAPI24SyslogServersParamsWithContext creates a new GetAPI24SyslogServersParams object
...
// NewGetAPI24SyslogServersParamsWithHTTPClient creates a new GetAPI24SyslogServersParams object
...
/*GetAPI24SyslogServersParams contains all the parameters to send to the API endpoint
for the get API 24 syslog servers operation typically these are written to a http.Request
*/
...
func (o *GetAPI24SyslogServersParams) WithTimeout(timeout time.Duration) *GetAPI24SyslogServersParams {
...
func (o *GetAPI24SyslogServersParams) WithContext(ctx context.Context) *GetAPI24SyslogServersParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetAPI24SyslogServersParams) WithHTTPClient(client *http.Client) *GetAPI24SyslogServersParams {
...
func (o *GetAPI24SyslogServersParams) WithFilter(filter *string) *GetAPI24SyslogServersParams {
	o.SetFilter(filter)
	return o
}
...
func (o *GetAPI24SyslogServersParams) WithLimit(limit *int32) *GetAPI24SyslogServersParams {
	o.SetLimit(limit)
	return o
}
...
func (o *GetAPI24SyslogServersParams) WithNames(names []string) *GetAPI24SyslogServersParams {
	o.SetNames(names)
	return o
}
...
func (o *GetAPI24SyslogServersParams) WithOffset(offset *int32) *GetAPI24SyslogServersParams {
	o.SetOffset(offset)
	return o
}
...
func (o *GetAPI24SyslogServersParams) WithSort(sort []string) *GetAPI24SyslogServersParams {
	o.SetSort(sort)
	return o
}
...
func (o *GetAPI24SyslogServersParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
