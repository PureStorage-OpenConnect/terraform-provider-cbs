...
// NewGetAPI24SyslogServersSettingsParams creates a new GetAPI24SyslogServersSettingsParams object
// with the default values initialized.
func NewGetAPI24SyslogServersSettingsParams() *GetAPI24SyslogServersSettingsParams {
	var ()
	return &GetAPI24SyslogServersSettingsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24SyslogServersSettingsParamsWithTimeout creates a new GetAPI24SyslogServersSettingsParams object
...
// NewGetAPI24SyslogServersSettingsParamsWithContext creates a new GetAPI24SyslogServersSettingsParams object
...
// NewGetAPI24SyslogServersSettingsParamsWithHTTPClient creates a new GetAPI24SyslogServersSettingsParams object
...
/*GetAPI24SyslogServersSettingsParams contains all the parameters to send to the API endpoint
for the get API 24 syslog servers settings operation typically these are written to a http.Request
*/
...
func (o *GetAPI24SyslogServersSettingsParams) WithTimeout(timeout time.Duration) *GetAPI24SyslogServersSettingsParams {
...
func (o *GetAPI24SyslogServersSettingsParams) WithContext(ctx context.Context) *GetAPI24SyslogServersSettingsParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get API 24 syslog servers settings params
func (o *GetAPI24SyslogServersSettingsParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get API 24 syslog servers settings params
func (o *GetAPI24SyslogServersSettingsParams) WithHTTPClient(client *http.Client) *GetAPI24SyslogServersSettingsParams {
...
func (o *GetAPI24SyslogServersSettingsParams) WithAuthorization(authorization *string) *GetAPI24SyslogServersSettingsParams {
...
func (o *GetAPI24SyslogServersSettingsParams) WithXRequestID(xRequestID *string) *GetAPI24SyslogServersSettingsParams {
...
func (o *GetAPI24SyslogServersSettingsParams) WithFilter(filter *string) *GetAPI24SyslogServersSettingsParams {
	o.SetFilter(filter)
	return o
}
...
func (o *GetAPI24SyslogServersSettingsParams) WithLimit(limit *int32) *GetAPI24SyslogServersSettingsParams {
	o.SetLimit(limit)
	return o
}
...
func (o *GetAPI24SyslogServersSettingsParams) WithOffset(offset *int32) *GetAPI24SyslogServersSettingsParams {
	o.SetOffset(offset)
	return o
}
...
func (o *GetAPI24SyslogServersSettingsParams) WithSort(sort []string) *GetAPI24SyslogServersSettingsParams {
	o.SetSort(sort)
	return o
}
...
func (o *GetAPI24SyslogServersSettingsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
