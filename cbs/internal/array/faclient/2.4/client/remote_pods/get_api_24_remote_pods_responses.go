...
func (o *GetAPI24RemotePodsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewGetApi24RemotePodsBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewGetApi24RemotePodsBadRequest() *GetApi24RemotePodsBadRequest {
	return &GetApi24RemotePodsBadRequest{}
}
...
func (o *GetApi24RemotePodsBadRequest) Error() string {
	return fmt.Sprintf("[GET /api/2.4/remote-pods][%d] getApi24RemotePodsBadRequest  %+v", 400, o.Payload)
}
...
func (o *GetApi24RemotePodsBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
