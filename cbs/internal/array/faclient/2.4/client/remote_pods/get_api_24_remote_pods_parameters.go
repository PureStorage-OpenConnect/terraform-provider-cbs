...
// NewGetAPI24RemotePodsParams creates a new GetAPI24RemotePodsParams object
// with the default values initialized.
func NewGetAPI24RemotePodsParams() *GetAPI24RemotePodsParams {
	var ()
	return &GetAPI24RemotePodsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24RemotePodsParamsWithTimeout creates a new GetAPI24RemotePodsParams object
...
// NewGetAPI24RemotePodsParamsWithContext creates a new GetAPI24RemotePodsParams object
...
// NewGetAPI24RemotePodsParamsWithHTTPClient creates a new GetAPI24RemotePodsParams object
...
/*GetAPI24RemotePodsParams contains all the parameters to send to the API endpoint
for the get API 24 remote pods operation typically these are written to a http.Request
*/
...
func (o *GetAPI24RemotePodsParams) WithTimeout(timeout time.Duration) *GetAPI24RemotePodsParams {
...
func (o *GetAPI24RemotePodsParams) WithContext(ctx context.Context) *GetAPI24RemotePodsParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetAPI24RemotePodsParams) WithFilter(filter *string) *GetAPI24RemotePodsParams {
	o.SetFilter(filter)
	return o
}
...
func (o *GetAPI24RemotePodsParams) WithIds(ids []string) *GetAPI24RemotePodsParams {
	o.SetIds(ids)
	return o
}
...
func (o *GetAPI24RemotePodsParams) WithLimit(limit *int32) *GetAPI24RemotePodsParams {
	o.SetLimit(limit)
	return o
}
...
func (o *GetAPI24RemotePodsParams) WithNames(names []string) *GetAPI24RemotePodsParams {
	o.SetNames(names)
	return o
}
...
func (o *GetAPI24RemotePodsParams) WithOffset(offset *int32) *GetAPI24RemotePodsParams {
	o.SetOffset(offset)
	return o
}
...
func (o *GetAPI24RemotePodsParams) WithOn(on []string) *GetAPI24RemotePodsParams {
	o.SetOn(on)
	return o
}
...
func (o *GetAPI24RemotePodsParams) WithSort(sort []string) *GetAPI24RemotePodsParams {
	o.SetSort(sort)
	return o
}
...
func (o *GetAPI24RemotePodsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
