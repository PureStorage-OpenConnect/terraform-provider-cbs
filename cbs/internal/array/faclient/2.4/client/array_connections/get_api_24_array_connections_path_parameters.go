...
// NewGetAPI24ArrayConnectionsPathParams creates a new GetAPI24ArrayConnectionsPathParams object
// with the default values initialized.
func NewGetAPI24ArrayConnectionsPathParams() *GetAPI24ArrayConnectionsPathParams {
	var ()
	return &GetAPI24ArrayConnectionsPathParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24ArrayConnectionsPathParamsWithTimeout creates a new GetAPI24ArrayConnectionsPathParams object
...
// NewGetAPI24ArrayConnectionsPathParamsWithContext creates a new GetAPI24ArrayConnectionsPathParams object
...
// NewGetAPI24ArrayConnectionsPathParamsWithHTTPClient creates a new GetAPI24ArrayConnectionsPathParams object
...
/*GetAPI24ArrayConnectionsPathParams contains all the parameters to send to the API endpoint
for the get API 24 array connections path operation typically these are written to a http.Request
*/
...
func (o *GetAPI24ArrayConnectionsPathParams) WithTimeout(timeout time.Duration) *GetAPI24ArrayConnectionsPathParams {
...
func (o *GetAPI24ArrayConnectionsPathParams) WithContext(ctx context.Context) *GetAPI24ArrayConnectionsPathParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get API 24 array connections path params
func (o *GetAPI24ArrayConnectionsPathParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get API 24 array connections path params
func (o *GetAPI24ArrayConnectionsPathParams) WithHTTPClient(client *http.Client) *GetAPI24ArrayConnectionsPathParams {
...
func (o *GetAPI24ArrayConnectionsPathParams) WithAuthorization(authorization *string) *GetAPI24ArrayConnectionsPathParams {
...
func (o *GetAPI24ArrayConnectionsPathParams) WithXRequestID(xRequestID *string) *GetAPI24ArrayConnectionsPathParams {
...
func (o *GetAPI24ArrayConnectionsPathParams) WithFilter(filter *string) *GetAPI24ArrayConnectionsPathParams {
	o.SetFilter(filter)
	return o
}
...
func (o *GetAPI24ArrayConnectionsPathParams) WithLimit(limit *int32) *GetAPI24ArrayConnectionsPathParams {
	o.SetLimit(limit)
	return o
}
...
func (o *GetAPI24ArrayConnectionsPathParams) WithNames(names []string) *GetAPI24ArrayConnectionsPathParams {
	o.SetNames(names)
	return o
}
...
func (o *GetAPI24ArrayConnectionsPathParams) WithOffset(offset *int32) *GetAPI24ArrayConnectionsPathParams {
	o.SetOffset(offset)
	return o
}
...
func (o *GetAPI24ArrayConnectionsPathParams) WithSort(sort []string) *GetAPI24ArrayConnectionsPathParams {
	o.SetSort(sort)
	return o
}
...
func (o *GetAPI24ArrayConnectionsPathParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
