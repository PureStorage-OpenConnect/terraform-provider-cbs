...
func (o *PatchAPI24ArrayConnectionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewPatchApi24ArrayConnectionsBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *PatchApi24ArrayConnectionsBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /api/2.4/array-connections][%d] patchApi24ArrayConnectionsBadRequest  %+v", 400, o.Payload)
}

func (o *PatchApi24ArrayConnectionsBadRequest) GetPayload() *models.Error {
	return o.Payload
}

func (o *PatchApi24ArrayConnectionsBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
