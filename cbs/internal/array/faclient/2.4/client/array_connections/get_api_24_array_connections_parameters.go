...
// NewGetAPI24ArrayConnectionsParams creates a new GetAPI24ArrayConnectionsParams object
// with the default values initialized.
func NewGetAPI24ArrayConnectionsParams() *GetAPI24ArrayConnectionsParams {
	var ()
	return &GetAPI24ArrayConnectionsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24ArrayConnectionsParamsWithTimeout creates a new GetAPI24ArrayConnectionsParams object
...
// NewGetAPI24ArrayConnectionsParamsWithContext creates a new GetAPI24ArrayConnectionsParams object
...
// NewGetAPI24ArrayConnectionsParamsWithHTTPClient creates a new GetAPI24ArrayConnectionsParams object
...
/*GetAPI24ArrayConnectionsParams contains all the parameters to send to the API endpoint
for the get API 24 array connections operation typically these are written to a http.Request
*/
...
func (o *GetAPI24ArrayConnectionsParams) WithTimeout(timeout time.Duration) *GetAPI24ArrayConnectionsParams {
...
func (o *GetAPI24ArrayConnectionsParams) WithContext(ctx context.Context) *GetAPI24ArrayConnectionsParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetAPI24ArrayConnectionsParams) WithHTTPClient(client *http.Client) *GetAPI24ArrayConnectionsParams {
...
func (o *GetAPI24ArrayConnectionsParams) WithXRequestID(xRequestID *string) *GetAPI24ArrayConnectionsParams {
...
func (o *GetAPI24ArrayConnectionsParams) WithFilter(filter *string) *GetAPI24ArrayConnectionsParams {
	o.SetFilter(filter)
	return o
}
...
func (o *GetAPI24ArrayConnectionsParams) WithLimit(limit *int32) *GetAPI24ArrayConnectionsParams {
	o.SetLimit(limit)
	return o
}
...
func (o *GetAPI24ArrayConnectionsParams) WithNames(names []string) *GetAPI24ArrayConnectionsParams {
	o.SetNames(names)
	return o
}
...
func (o *GetAPI24ArrayConnectionsParams) WithOffset(offset *int32) *GetAPI24ArrayConnectionsParams {
	o.SetOffset(offset)
	return o
}
...
func (o *GetAPI24ArrayConnectionsParams) WithSort(sort []string) *GetAPI24ArrayConnectionsParams {
	o.SetSort(sort)
	return o
}
...
func (o *GetAPI24ArrayConnectionsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
