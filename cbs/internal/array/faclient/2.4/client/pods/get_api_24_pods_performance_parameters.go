...
// NewGetAPI24PodsPerformanceParams creates a new GetAPI24PodsPerformanceParams object
// with the default values initialized.
func NewGetAPI24PodsPerformanceParams() *GetAPI24PodsPerformanceParams {
	var ()
	return &GetAPI24PodsPerformanceParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24PodsPerformanceParamsWithTimeout creates a new GetAPI24PodsPerformanceParams object
...
// NewGetAPI24PodsPerformanceParamsWithContext creates a new GetAPI24PodsPerformanceParams object
...
// NewGetAPI24PodsPerformanceParamsWithHTTPClient creates a new GetAPI24PodsPerformanceParams object
...
/*GetAPI24PodsPerformanceParams contains all the parameters to send to the API endpoint
for the get API 24 pods performance operation typically these are written to a http.Request
*/
...
func (o *GetAPI24PodsPerformanceParams) WithTimeout(timeout time.Duration) *GetAPI24PodsPerformanceParams {
...
func (o *GetAPI24PodsPerformanceParams) WithContext(ctx context.Context) *GetAPI24PodsPerformanceParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetAPI24PodsPerformanceParams) WithHTTPClient(client *http.Client) *GetAPI24PodsPerformanceParams {
...
func (o *GetAPI24PodsPerformanceParams) WithDestroyed(destroyed *bool) *GetAPI24PodsPerformanceParams {
...
func (o *GetAPI24PodsPerformanceParams) WithEndTime(endTime *int64) *GetAPI24PodsPerformanceParams {
...
func (o *GetAPI24PodsPerformanceParams) WithFilter(filter *string) *GetAPI24PodsPerformanceParams {
	o.SetFilter(filter)
	return o
}
...
func (o *GetAPI24PodsPerformanceParams) WithIds(ids []string) *GetAPI24PodsPerformanceParams {
	o.SetIds(ids)
	return o
}
...
func (o *GetAPI24PodsPerformanceParams) WithLimit(limit *int32) *GetAPI24PodsPerformanceParams {
	o.SetLimit(limit)
	return o
}
...
func (o *GetAPI24PodsPerformanceParams) WithNames(names []string) *GetAPI24PodsPerformanceParams {
	o.SetNames(names)
	return o
}
...
func (o *GetAPI24PodsPerformanceParams) WithOffset(offset *int32) *GetAPI24PodsPerformanceParams {
	o.SetOffset(offset)
	return o
}
...
func (o *GetAPI24PodsPerformanceParams) WithSort(sort []string) *GetAPI24PodsPerformanceParams {
	o.SetSort(sort)
	return o
}
...
func (o *GetAPI24PodsPerformanceParams) WithStartTime(startTime *int64) *GetAPI24PodsPerformanceParams {
...
func (o *GetAPI24PodsPerformanceParams) WithTotalOnly(totalOnly *bool) *GetAPI24PodsPerformanceParams {
...
func (o *GetAPI24PodsPerformanceParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
