...
func (o *PostAPI24PodsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewPostApi24PodsBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewPostApi24PodsBadRequest() *PostApi24PodsBadRequest {
	return &PostApi24PodsBadRequest{}
}
...
func (o *PostApi24PodsBadRequest) Error() string {
	return fmt.Sprintf("[POST /api/2.4/pods][%d] postApi24PodsBadRequest  %+v", 400, o.Payload)
}
...
func (o *PostApi24PodsBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
