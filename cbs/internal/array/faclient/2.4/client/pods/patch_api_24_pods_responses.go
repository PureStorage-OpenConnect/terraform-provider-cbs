...
func (o *PatchAPI24PodsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewPatchApi24PodsBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewPatchApi24PodsBadRequest() *PatchApi24PodsBadRequest {
	return &PatchApi24PodsBadRequest{}
}
...
func (o *PatchApi24PodsBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /api/2.4/pods][%d] patchApi24PodsBadRequest  %+v", 400, o.Payload)
}
...
func (o *PatchApi24PodsBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
