...
func (o *PatchAPI24RemoteVolumeSnapshotsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewPatchApi24RemoteVolumeSnapshotsBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewPatchApi24RemoteVolumeSnapshotsBadRequest() *PatchApi24RemoteVolumeSnapshotsBadRequest {
	return &PatchApi24RemoteVolumeSnapshotsBadRequest{}
}
...
func (o *PatchApi24RemoteVolumeSnapshotsBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /api/2.4/remote-volume-snapshots][%d] patchApi24RemoteVolumeSnapshotsBadRequest  %+v", 400, o.Payload)
}

func (o *PatchApi24RemoteVolumeSnapshotsBadRequest) GetPayload() *models.Error {
	return o.Payload
}

func (o *PatchApi24RemoteVolumeSnapshotsBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
