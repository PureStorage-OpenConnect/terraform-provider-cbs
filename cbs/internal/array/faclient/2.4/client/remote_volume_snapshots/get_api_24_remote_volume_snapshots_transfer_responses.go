...
func (o *GetAPI24RemoteVolumeSnapshotsTransferReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewGetApi24RemoteVolumeSnapshotsTransferBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewGetApi24RemoteVolumeSnapshotsTransferBadRequest() *GetApi24RemoteVolumeSnapshotsTransferBadRequest {
	return &GetApi24RemoteVolumeSnapshotsTransferBadRequest{}
}
...
func (o *GetApi24RemoteVolumeSnapshotsTransferBadRequest) Error() string {
	return fmt.Sprintf("[GET /api/2.4/remote-volume-snapshots/transfer][%d] getApi24RemoteVolumeSnapshotsTransferBadRequest  %+v", 400, o.Payload)
}

func (o *GetApi24RemoteVolumeSnapshotsTransferBadRequest) GetPayload() *models.Error {
	return o.Payload
}

func (o *GetApi24RemoteVolumeSnapshotsTransferBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
