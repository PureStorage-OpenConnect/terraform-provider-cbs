...
// NewGetAPI24PoliciesParams creates a new GetAPI24PoliciesParams object
// with the default values initialized.
func NewGetAPI24PoliciesParams() *GetAPI24PoliciesParams {
	var ()
	return &GetAPI24PoliciesParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24PoliciesParamsWithTimeout creates a new GetAPI24PoliciesParams object
...
// NewGetAPI24PoliciesParamsWithContext creates a new GetAPI24PoliciesParams object
...
// NewGetAPI24PoliciesParamsWithHTTPClient creates a new GetAPI24PoliciesParams object
...
/*GetAPI24PoliciesParams contains all the parameters to send to the API endpoint
for the get API 24 policies operation typically these are written to a http.Request
*/
