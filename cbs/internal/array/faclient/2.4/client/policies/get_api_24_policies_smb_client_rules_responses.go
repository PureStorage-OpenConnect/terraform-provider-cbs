...
func (o *GetAPI24PoliciesSmbClientRulesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewGetApi24PoliciesSmbClientRulesBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewGetApi24PoliciesSmbClientRulesBadRequest() *GetApi24PoliciesSmbClientRulesBadRequest {
	return &GetApi24PoliciesSmbClientRulesBadRequest{}
}
...
func (o *GetApi24PoliciesSmbClientRulesBadRequest) Error() string {
	return fmt.Sprintf("[GET /api/2.4/policies/smb/client-rules][%d] getApi24PoliciesSmbClientRulesBadRequest  %+v", 400, o.Payload)
}
...
func (o *GetApi24PoliciesSmbClientRulesBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
