...
// NewPatchAPI24PoliciesSmbParams creates a new PatchAPI24PoliciesSmbParams object
// with the default values initialized.
func NewPatchAPI24PoliciesSmbParams() *PatchAPI24PoliciesSmbParams {
	var ()
	return &PatchAPI24PoliciesSmbParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPatchAPI24PoliciesSmbParamsWithTimeout creates a new PatchAPI24PoliciesSmbParams object
...
// NewPatchAPI24PoliciesSmbParamsWithContext creates a new PatchAPI24PoliciesSmbParams object
...
// NewPatchAPI24PoliciesSmbParamsWithHTTPClient creates a new PatchAPI24PoliciesSmbParams object
...
/*PatchAPI24PoliciesSmbParams contains all the parameters to send to the API endpoint
for the patch API 24 policies smb operation typically these are written to a http.Request
*/
