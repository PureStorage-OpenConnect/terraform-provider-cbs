...
// NewGetAPI24PoliciesSmbParams creates a new GetAPI24PoliciesSmbParams object
// with the default values initialized.
func NewGetAPI24PoliciesSmbParams() *GetAPI24PoliciesSmbParams {
	var ()
	return &GetAPI24PoliciesSmbParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24PoliciesSmbParamsWithTimeout creates a new GetAPI24PoliciesSmbParams object
...
// NewGetAPI24PoliciesSmbParamsWithContext creates a new GetAPI24PoliciesSmbParams object
...
// NewGetAPI24PoliciesSmbParamsWithHTTPClient creates a new GetAPI24PoliciesSmbParams object
...
/*GetAPI24PoliciesSmbParams contains all the parameters to send to the API endpoint
for the get API 24 policies smb operation typically these are written to a http.Request
*/
