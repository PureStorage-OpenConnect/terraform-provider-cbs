...
func (o *PostAPI24PoliciesSnapshotRulesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewPostApi24PoliciesSnapshotRulesBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewPostApi24PoliciesSnapshotRulesBadRequest() *PostApi24PoliciesSnapshotRulesBadRequest {
	return &PostApi24PoliciesSnapshotRulesBadRequest{}
}
...
func (o *PostApi24PoliciesSnapshotRulesBadRequest) Error() string {
	return fmt.Sprintf("[POST /api/2.4/policies/snapshot/rules][%d] postApi24PoliciesSnapshotRulesBadRequest  %+v", 400, o.Payload)
}
...
func (o *PostApi24PoliciesSnapshotRulesBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
