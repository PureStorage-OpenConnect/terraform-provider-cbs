...
// NewGetAPI24PortsInitiatorsParams creates a new GetAPI24PortsInitiatorsParams object
// with the default values initialized.
func NewGetAPI24PortsInitiatorsParams() *GetAPI24PortsInitiatorsParams {
	var ()
	return &GetAPI24PortsInitiatorsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24PortsInitiatorsParamsWithTimeout creates a new GetAPI24PortsInitiatorsParams object
...
// NewGetAPI24PortsInitiatorsParamsWithContext creates a new GetAPI24PortsInitiatorsParams object
...
// NewGetAPI24PortsInitiatorsParamsWithHTTPClient creates a new GetAPI24PortsInitiatorsParams object
...
/*GetAPI24PortsInitiatorsParams contains all the parameters to send to the API endpoint
for the get API 24 ports initiators operation typically these are written to a http.Request
*/
...
func (o *GetAPI24PortsInitiatorsParams) WithTimeout(timeout time.Duration) *GetAPI24PortsInitiatorsParams {
...
func (o *GetAPI24PortsInitiatorsParams) WithContext(ctx context.Context) *GetAPI24PortsInitiatorsParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetAPI24PortsInitiatorsParams) WithHTTPClient(client *http.Client) *GetAPI24PortsInitiatorsParams {
...
func (o *GetAPI24PortsInitiatorsParams) WithFilter(filter *string) *GetAPI24PortsInitiatorsParams {
	o.SetFilter(filter)
	return o
}
...
func (o *GetAPI24PortsInitiatorsParams) WithLimit(limit *int32) *GetAPI24PortsInitiatorsParams {
	o.SetLimit(limit)
	return o
}
...
func (o *GetAPI24PortsInitiatorsParams) WithNames(names []string) *GetAPI24PortsInitiatorsParams {
	o.SetNames(names)
	return o
}
...
func (o *GetAPI24PortsInitiatorsParams) WithOffset(offset *int32) *GetAPI24PortsInitiatorsParams {
	o.SetOffset(offset)
	return o
}
...
func (o *GetAPI24PortsInitiatorsParams) WithSort(sort []string) *GetAPI24PortsInitiatorsParams {
	o.SetSort(sort)
	return o
}
...
func (o *GetAPI24PortsInitiatorsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
