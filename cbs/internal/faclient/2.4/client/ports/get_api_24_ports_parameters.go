...
// NewGetAPI24PortsParams creates a new GetAPI24PortsParams object
// with the default values initialized.
func NewGetAPI24PortsParams() *GetAPI24PortsParams {
	var ()
	return &GetAPI24PortsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24PortsParamsWithTimeout creates a new GetAPI24PortsParams object
...
// NewGetAPI24PortsParamsWithContext creates a new GetAPI24PortsParams object
...
// NewGetAPI24PortsParamsWithHTTPClient creates a new GetAPI24PortsParams object
...
/*GetAPI24PortsParams contains all the parameters to send to the API endpoint
for the get API 24 ports operation typically these are written to a http.Request
*/
...
func (o *GetAPI24PortsParams) WithContext(ctx context.Context) *GetAPI24PortsParams {
	o.SetContext(ctx)
	return o
}
