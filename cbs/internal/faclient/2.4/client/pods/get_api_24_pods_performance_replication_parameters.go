...
// NewGetAPI24PodsPerformanceReplicationParams creates a new GetAPI24PodsPerformanceReplicationParams object
// with the default values initialized.
func NewGetAPI24PodsPerformanceReplicationParams() *GetAPI24PodsPerformanceReplicationParams {
	var ()
	return &GetAPI24PodsPerformanceReplicationParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24PodsPerformanceReplicationParamsWithTimeout creates a new GetAPI24PodsPerformanceReplicationParams object
...
// NewGetAPI24PodsPerformanceReplicationParamsWithContext creates a new GetAPI24PodsPerformanceReplicationParams object
...
// NewGetAPI24PodsPerformanceReplicationParamsWithHTTPClient creates a new GetAPI24PodsPerformanceReplicationParams object
...
/*GetAPI24PodsPerformanceReplicationParams contains all the parameters to send to the API endpoint
for the get API 24 pods performance replication operation typically these are written to a http.Request
*/
...
func (o *GetAPI24PodsPerformanceReplicationParams) WithTimeout(timeout time.Duration) *GetAPI24PodsPerformanceReplicationParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the get API 24 pods performance replication params
func (o *GetAPI24PodsPerformanceReplicationParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the get API 24 pods performance replication params
func (o *GetAPI24PodsPerformanceReplicationParams) WithContext(ctx context.Context) *GetAPI24PodsPerformanceReplicationParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get API 24 pods performance replication params
func (o *GetAPI24PodsPerformanceReplicationParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get API 24 pods performance replication params
func (o *GetAPI24PodsPerformanceReplicationParams) WithHTTPClient(client *http.Client) *GetAPI24PodsPerformanceReplicationParams {
...
func (o *GetAPI24PodsPerformanceReplicationParams) WithAuthorization(authorization *string) *GetAPI24PodsPerformanceReplicationParams {
...
func (o *GetAPI24PodsPerformanceReplicationParams) WithXRequestID(xRequestID *string) *GetAPI24PodsPerformanceReplicationParams {
...
func (o *GetAPI24PodsPerformanceReplicationParams) WithDestroyed(destroyed *bool) *GetAPI24PodsPerformanceReplicationParams {
...
func (o *GetAPI24PodsPerformanceReplicationParams) WithEndTime(endTime *int64) *GetAPI24PodsPerformanceReplicationParams {
...
func (o *GetAPI24PodsPerformanceReplicationParams) WithFilter(filter *string) *GetAPI24PodsPerformanceReplicationParams {
	o.SetFilter(filter)
	return o
}
...
func (o *GetAPI24PodsPerformanceReplicationParams) WithIds(ids []string) *GetAPI24PodsPerformanceReplicationParams {
	o.SetIds(ids)
	return o
}

// SetIds adds the ids to the get API 24 pods performance replication params
func (o *GetAPI24PodsPerformanceReplicationParams) SetIds(ids []string) {
	o.Ids = ids
}

// WithLimit adds the limit to the get API 24 pods performance replication params
func (o *GetAPI24PodsPerformanceReplicationParams) WithLimit(limit *int32) *GetAPI24PodsPerformanceReplicationParams {
	o.SetLimit(limit)
	return o
}
...
func (o *GetAPI24PodsPerformanceReplicationParams) WithNames(names []string) *GetAPI24PodsPerformanceReplicationParams {
	o.SetNames(names)
	return o
}
...
func (o *GetAPI24PodsPerformanceReplicationParams) WithOffset(offset *int32) *GetAPI24PodsPerformanceReplicationParams {
	o.SetOffset(offset)
	return o
}
...
func (o *GetAPI24PodsPerformanceReplicationParams) WithResolution(resolution *int64) *GetAPI24PodsPerformanceReplicationParams {
...
func (o *GetAPI24PodsPerformanceReplicationParams) WithSort(sort []string) *GetAPI24PodsPerformanceReplicationParams {
	o.SetSort(sort)
	return o
}

// SetSort adds the sort to the get API 24 pods performance replication params
func (o *GetAPI24PodsPerformanceReplicationParams) SetSort(sort []string) {
	o.Sort = sort
}

// WithStartTime adds the startTime to the get API 24 pods performance replication params
func (o *GetAPI24PodsPerformanceReplicationParams) WithStartTime(startTime *int64) *GetAPI24PodsPerformanceReplicationParams {
...
func (o *GetAPI24PodsPerformanceReplicationParams) WithTotalItemCount(totalItemCount *bool) *GetAPI24PodsPerformanceReplicationParams {
...
func (o *GetAPI24PodsPerformanceReplicationParams) WithTotalOnly(totalOnly *bool) *GetAPI24PodsPerformanceReplicationParams {
...
func (o *GetAPI24PodsPerformanceReplicationParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
