...
// NewGetAPI24HostsHostGroupsParams creates a new GetAPI24HostsHostGroupsParams object
// with the default values initialized.
func NewGetAPI24HostsHostGroupsParams() *GetAPI24HostsHostGroupsParams {
	var ()
	return &GetAPI24HostsHostGroupsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24HostsHostGroupsParamsWithTimeout creates a new GetAPI24HostsHostGroupsParams object
...
// NewGetAPI24HostsHostGroupsParamsWithContext creates a new GetAPI24HostsHostGroupsParams object
...
// NewGetAPI24HostsHostGroupsParamsWithHTTPClient creates a new GetAPI24HostsHostGroupsParams object
...
/*GetAPI24HostsHostGroupsParams contains all the parameters to send to the API endpoint
for the get API 24 hosts host groups operation typically these are written to a http.Request
*/
type GetAPI24HostsHostGroupsParams struct {
