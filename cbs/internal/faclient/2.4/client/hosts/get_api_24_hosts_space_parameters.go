...
// NewGetAPI24HostsSpaceParams creates a new GetAPI24HostsSpaceParams object
// with the default values initialized.
func NewGetAPI24HostsSpaceParams() *GetAPI24HostsSpaceParams {
	var ()
	return &GetAPI24HostsSpaceParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24HostsSpaceParamsWithTimeout creates a new GetAPI24HostsSpaceParams object
...
// NewGetAPI24HostsSpaceParamsWithContext creates a new GetAPI24HostsSpaceParams object
...
// NewGetAPI24HostsSpaceParamsWithHTTPClient creates a new GetAPI24HostsSpaceParams object
...
/*GetAPI24HostsSpaceParams contains all the parameters to send to the API endpoint
for the get API 24 hosts space operation typically these are written to a http.Request
*/
type GetAPI24HostsSpaceParams struct {
