...
// NewPostAPI24SubnetsParams creates a new PostAPI24SubnetsParams object
// with the default values initialized.
func NewPostAPI24SubnetsParams() *PostAPI24SubnetsParams {
	var ()
	return &PostAPI24SubnetsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostAPI24SubnetsParamsWithTimeout creates a new PostAPI24SubnetsParams object
...
// NewPostAPI24SubnetsParamsWithContext creates a new PostAPI24SubnetsParams object
...
// NewPostAPI24SubnetsParamsWithHTTPClient creates a new PostAPI24SubnetsParams object
...
/*PostAPI24SubnetsParams contains all the parameters to send to the API endpoint
for the post API 24 subnets operation typically these are written to a http.Request
*/
...
func (o *PostAPI24SubnetsParams) WithTimeout(timeout time.Duration) *PostAPI24SubnetsParams {
...
func (o *PostAPI24SubnetsParams) WithContext(ctx context.Context) *PostAPI24SubnetsParams {
	o.SetContext(ctx)
	return o
}
...
func (o *PostAPI24SubnetsParams) WithSubnet(subnet *models.SubnetPost) *PostAPI24SubnetsParams {
	o.SetSubnet(subnet)
	return o
}
...
func (o *PostAPI24SubnetsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
