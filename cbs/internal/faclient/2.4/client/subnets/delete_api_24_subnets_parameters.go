...
// NewDeleteAPI24SubnetsParams creates a new DeleteAPI24SubnetsParams object
// with the default values initialized.
func NewDeleteAPI24SubnetsParams() *DeleteAPI24SubnetsParams {
	var ()
	return &DeleteAPI24SubnetsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewDeleteAPI24SubnetsParamsWithTimeout creates a new DeleteAPI24SubnetsParams object
...
// NewDeleteAPI24SubnetsParamsWithContext creates a new DeleteAPI24SubnetsParams object
...
// NewDeleteAPI24SubnetsParamsWithHTTPClient creates a new DeleteAPI24SubnetsParams object
...
/*DeleteAPI24SubnetsParams contains all the parameters to send to the API endpoint
for the delete API 24 subnets operation typically these are written to a http.Request
*/
...
func (o *DeleteAPI24SubnetsParams) WithTimeout(timeout time.Duration) *DeleteAPI24SubnetsParams {
...
func (o *DeleteAPI24SubnetsParams) WithContext(ctx context.Context) *DeleteAPI24SubnetsParams {
	o.SetContext(ctx)
	return o
}
...
func (o *DeleteAPI24SubnetsParams) WithNames(names []string) *DeleteAPI24SubnetsParams {
	o.SetNames(names)
	return o
}
...
func (o *DeleteAPI24SubnetsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
