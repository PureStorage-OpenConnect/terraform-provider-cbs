...
// NewGetAPI24HardwareParams creates a new GetAPI24HardwareParams object
// with the default values initialized.
func NewGetAPI24HardwareParams() *GetAPI24HardwareParams {
	var ()
	return &GetAPI24HardwareParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24HardwareParamsWithTimeout creates a new GetAPI24HardwareParams object
...
// NewGetAPI24HardwareParamsWithContext creates a new GetAPI24HardwareParams object
...
// NewGetAPI24HardwareParamsWithHTTPClient creates a new GetAPI24HardwareParams object
...
/*GetAPI24HardwareParams contains all the parameters to send to the API endpoint
for the get API 24 hardware operation typically these are written to a http.Request
*/
...
func (o *GetAPI24HardwareParams) WithTimeout(timeout time.Duration) *GetAPI24HardwareParams {
...
func (o *GetAPI24HardwareParams) WithContext(ctx context.Context) *GetAPI24HardwareParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetAPI24HardwareParams) WithSort(sort []string) *GetAPI24HardwareParams {
	o.SetSort(sort)
	return o
}
...
func (o *GetAPI24HardwareParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
