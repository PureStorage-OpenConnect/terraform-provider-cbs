...
// NewGetAPI24ArraysSpaceParams creates a new GetAPI24ArraysSpaceParams object
// with the default values initialized.
func NewGetAPI24ArraysSpaceParams() *GetAPI24ArraysSpaceParams {
	var ()
	return &GetAPI24ArraysSpaceParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24ArraysSpaceParamsWithTimeout creates a new GetAPI24ArraysSpaceParams object
...
// NewGetAPI24ArraysSpaceParamsWithContext creates a new GetAPI24ArraysSpaceParams object
...
// NewGetAPI24ArraysSpaceParamsWithHTTPClient creates a new GetAPI24ArraysSpaceParams object
...
/*GetAPI24ArraysSpaceParams contains all the parameters to send to the API endpoint
for the get API 24 arrays space operation typically these are written to a http.Request
*/
type GetAPI24ArraysSpaceParams struct {
