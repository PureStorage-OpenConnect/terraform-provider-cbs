...
// NewGetAPI24MaintenanceWindowsParams creates a new GetAPI24MaintenanceWindowsParams object
// with the default values initialized.
func NewGetAPI24MaintenanceWindowsParams() *GetAPI24MaintenanceWindowsParams {
	var ()
	return &GetAPI24MaintenanceWindowsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24MaintenanceWindowsParamsWithTimeout creates a new GetAPI24MaintenanceWindowsParams object
...
// NewGetAPI24MaintenanceWindowsParamsWithContext creates a new GetAPI24MaintenanceWindowsParams object
...
// NewGetAPI24MaintenanceWindowsParamsWithHTTPClient creates a new GetAPI24MaintenanceWindowsParams object
...
/*GetAPI24MaintenanceWindowsParams contains all the parameters to send to the API endpoint
for the get API 24 maintenance windows operation typically these are written to a http.Request
*/
...
func (o *GetAPI24MaintenanceWindowsParams) WithTimeout(timeout time.Duration) *GetAPI24MaintenanceWindowsParams {
...
func (o *GetAPI24MaintenanceWindowsParams) WithContext(ctx context.Context) *GetAPI24MaintenanceWindowsParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get API 24 maintenance windows params
func (o *GetAPI24MaintenanceWindowsParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get API 24 maintenance windows params
func (o *GetAPI24MaintenanceWindowsParams) WithHTTPClient(client *http.Client) *GetAPI24MaintenanceWindowsParams {
...
func (o *GetAPI24MaintenanceWindowsParams) WithXRequestID(xRequestID *string) *GetAPI24MaintenanceWindowsParams {
...
func (o *GetAPI24MaintenanceWindowsParams) WithFilter(filter *string) *GetAPI24MaintenanceWindowsParams {
	o.SetFilter(filter)
	return o
}
...
func (o *GetAPI24MaintenanceWindowsParams) WithLimit(limit *int32) *GetAPI24MaintenanceWindowsParams {
	o.SetLimit(limit)
	return o
}
...
func (o *GetAPI24MaintenanceWindowsParams) WithNames(names []string) *GetAPI24MaintenanceWindowsParams {
	o.SetNames(names)
	return o
}
...
func (o *GetAPI24MaintenanceWindowsParams) WithOffset(offset *int32) *GetAPI24MaintenanceWindowsParams {
	o.SetOffset(offset)
	return o
}
...
func (o *GetAPI24MaintenanceWindowsParams) WithSort(sort []string) *GetAPI24MaintenanceWindowsParams {
	o.SetSort(sort)
	return o
}
...
func (o *GetAPI24MaintenanceWindowsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
