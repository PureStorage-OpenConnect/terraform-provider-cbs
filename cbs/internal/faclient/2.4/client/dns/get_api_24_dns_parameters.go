...
// NewGetAPI24DNSParams creates a new GetAPI24DNSParams object
// with the default values initialized.
func NewGetAPI24DNSParams() *GetAPI24DNSParams {
	var ()
	return &GetAPI24DNSParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24DNSParamsWithTimeout creates a new GetAPI24DNSParams object
...
// NewGetAPI24DNSParamsWithContext creates a new GetAPI24DNSParams object
...
// NewGetAPI24DNSParamsWithHTTPClient creates a new GetAPI24DNSParams object
...
/*GetAPI24DNSParams contains all the parameters to send to the API endpoint
for the get API 24 DNS operation typically these are written to a http.Request
*/
type GetAPI24DNSParams struct {
