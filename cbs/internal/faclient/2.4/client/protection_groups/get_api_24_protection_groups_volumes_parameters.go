...
// NewGetAPI24ProtectionGroupsVolumesParams creates a new GetAPI24ProtectionGroupsVolumesParams object
// with the default values initialized.
func NewGetAPI24ProtectionGroupsVolumesParams() *GetAPI24ProtectionGroupsVolumesParams {
	var ()
	return &GetAPI24ProtectionGroupsVolumesParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24ProtectionGroupsVolumesParamsWithTimeout creates a new GetAPI24ProtectionGroupsVolumesParams object
...
// NewGetAPI24ProtectionGroupsVolumesParamsWithContext creates a new GetAPI24ProtectionGroupsVolumesParams object
...
// NewGetAPI24ProtectionGroupsVolumesParamsWithHTTPClient creates a new GetAPI24ProtectionGroupsVolumesParams object
...
/*GetAPI24ProtectionGroupsVolumesParams contains all the parameters to send to the API endpoint
for the get API 24 protection groups volumes operation typically these are written to a http.Request
*/
...
func (o *GetAPI24ProtectionGroupsVolumesParams) WithTimeout(timeout time.Duration) *GetAPI24ProtectionGroupsVolumesParams {
...
func (o *GetAPI24ProtectionGroupsVolumesParams) WithContext(ctx context.Context) *GetAPI24ProtectionGroupsVolumesParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get API 24 protection groups volumes params
func (o *GetAPI24ProtectionGroupsVolumesParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get API 24 protection groups volumes params
func (o *GetAPI24ProtectionGroupsVolumesParams) WithHTTPClient(client *http.Client) *GetAPI24ProtectionGroupsVolumesParams {
...
func (o *GetAPI24ProtectionGroupsVolumesParams) WithAuthorization(authorization *string) *GetAPI24ProtectionGroupsVolumesParams {
...
func (o *GetAPI24ProtectionGroupsVolumesParams) WithXRequestID(xRequestID *string) *GetAPI24ProtectionGroupsVolumesParams {
...
func (o *GetAPI24ProtectionGroupsVolumesParams) WithFilter(filter *string) *GetAPI24ProtectionGroupsVolumesParams {
	o.SetFilter(filter)
	return o
}
...
func (o *GetAPI24ProtectionGroupsVolumesParams) WithGroupNames(groupNames []string) *GetAPI24ProtectionGroupsVolumesParams {
...
func (o *GetAPI24ProtectionGroupsVolumesParams) WithLimit(limit *int32) *GetAPI24ProtectionGroupsVolumesParams {
	o.SetLimit(limit)
	return o
}
...
func (o *GetAPI24ProtectionGroupsVolumesParams) WithMemberNames(memberNames []string) *GetAPI24ProtectionGroupsVolumesParams {
...
func (o *GetAPI24ProtectionGroupsVolumesParams) WithOffset(offset *int32) *GetAPI24ProtectionGroupsVolumesParams {
	o.SetOffset(offset)
	return o
}
...
func (o *GetAPI24ProtectionGroupsVolumesParams) WithSort(sort []string) *GetAPI24ProtectionGroupsVolumesParams {
	o.SetSort(sort)
	return o
}
...
func (o *GetAPI24ProtectionGroupsVolumesParams) WithTotalItemCount(totalItemCount *bool) *GetAPI24ProtectionGroupsVolumesParams {
...
func (o *GetAPI24ProtectionGroupsVolumesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
