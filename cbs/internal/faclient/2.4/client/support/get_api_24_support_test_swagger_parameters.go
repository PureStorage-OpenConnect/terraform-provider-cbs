...
// NewGetAPI24SupportTestParams creates a new GetAPI24SupportTestParams object
// with the default values initialized.
func NewGetAPI24SupportTestParams() *GetAPI24SupportTestParams {
	var ()
	return &GetAPI24SupportTestParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24SupportTestParamsWithTimeout creates a new GetAPI24SupportTestParams object
...
// NewGetAPI24SupportTestParamsWithContext creates a new GetAPI24SupportTestParams object
...
// NewGetAPI24SupportTestParamsWithHTTPClient creates a new GetAPI24SupportTestParams object
...
/*GetAPI24SupportTestParams contains all the parameters to send to the API endpoint
for the get API 24 support test operation typically these are written to a http.Request
*/
...
func (o *GetAPI24SupportTestParams) WithTimeout(timeout time.Duration) *GetAPI24SupportTestParams {
...
func (o *GetAPI24SupportTestParams) WithContext(ctx context.Context) *GetAPI24SupportTestParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetAPI24SupportTestParams) WithFilter(filter *string) *GetAPI24SupportTestParams {
	o.SetFilter(filter)
	return o
}
...
func (o *GetAPI24SupportTestParams) WithLimit(limit *int32) *GetAPI24SupportTestParams {
	o.SetLimit(limit)
	return o
}
...
func (o *GetAPI24SupportTestParams) WithOffset(offset *int32) *GetAPI24SupportTestParams {
	o.SetOffset(offset)
	return o
}
...
func (o *GetAPI24SupportTestParams) WithSort(sort []string) *GetAPI24SupportTestParams {
	o.SetSort(sort)
	return o
}
...
func (o *GetAPI24SupportTestParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.TestType != nil {
		...
		// query param test_type
		var qrTestType string
		if o.TestType != nil {
			qrTestType = *o.TestType
		}
		qTestType := qrTestType
		if qTestType != "" {

			if err := r.SetQueryParam("test_type", qTestType); err != nil {
				return err
			}
		}
