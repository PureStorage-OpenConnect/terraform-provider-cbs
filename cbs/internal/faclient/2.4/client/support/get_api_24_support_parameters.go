...
// NewGetAPI24SupportParams creates a new GetAPI24SupportParams object
// with the default values initialized.
func NewGetAPI24SupportParams() *GetAPI24SupportParams {
	var ()
	return &GetAPI24SupportParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24SupportParamsWithTimeout creates a new GetAPI24SupportParams object
...
// NewGetAPI24SupportParamsWithContext creates a new GetAPI24SupportParams object
...
// NewGetAPI24SupportParamsWithHTTPClient creates a new GetAPI24SupportParams object
...
/*GetAPI24SupportParams contains all the parameters to send to the API endpoint
for the get API 24 support operation typically these are written to a http.Request
*/
...
func (o *GetAPI24SupportParams) WithContext(ctx context.Context) *GetAPI24SupportParams {
	o.SetContext(ctx)
	return o
}
