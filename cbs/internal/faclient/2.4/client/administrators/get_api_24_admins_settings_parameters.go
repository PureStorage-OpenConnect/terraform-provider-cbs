...
// NewGetAPI24AdminsSettingsParams creates a new GetAPI24AdminsSettingsParams object
// with the default values initialized.
func NewGetAPI24AdminsSettingsParams() *GetAPI24AdminsSettingsParams {
	var ()
	return &GetAPI24AdminsSettingsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24AdminsSettingsParamsWithTimeout creates a new GetAPI24AdminsSettingsParams object
...
// NewGetAPI24AdminsSettingsParamsWithContext creates a new GetAPI24AdminsSettingsParams object
...
// NewGetAPI24AdminsSettingsParamsWithHTTPClient creates a new GetAPI24AdminsSettingsParams object
...
/*GetAPI24AdminsSettingsParams contains all the parameters to send to the API endpoint
for the get API 24 admins settings operation typically these are written to a http.Request
*/
...
func (o *GetAPI24AdminsSettingsParams) WithTimeout(timeout time.Duration) *GetAPI24AdminsSettingsParams {
...
func (o *GetAPI24AdminsSettingsParams) WithContext(ctx context.Context) *GetAPI24AdminsSettingsParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetAPI24AdminsSettingsParams) WithHTTPClient(client *http.Client) *GetAPI24AdminsSettingsParams {
...
func (o *GetAPI24AdminsSettingsParams) WithFilter(filter *string) *GetAPI24AdminsSettingsParams {
	o.SetFilter(filter)
	return o
}
...
func (o *GetAPI24AdminsSettingsParams) WithLimit(limit *int32) *GetAPI24AdminsSettingsParams {
	o.SetLimit(limit)
	return o
}
...
func (o *GetAPI24AdminsSettingsParams) WithOffset(offset *int32) *GetAPI24AdminsSettingsParams {
	o.SetOffset(offset)
	return o
}
...
func (o *GetAPI24AdminsSettingsParams) WithSort(sort []string) *GetAPI24AdminsSettingsParams {
	o.SetSort(sort)
	return o
}
...
func (o *GetAPI24AdminsSettingsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
