...
// NewPatchAPI24KMIPParams creates a new PatchAPI24KMIPParams object
// with the default values initialized.
func NewPatchAPI24KMIPParams() *PatchAPI24KMIPParams {
	var ()
	return &PatchAPI24KMIPParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPatchAPI24KMIPParamsWithTimeout creates a new PatchAPI24KMIPParams object
...
// NewPatchAPI24KMIPParamsWithContext creates a new PatchAPI24KMIPParams object
...
// NewPatchAPI24KMIPParamsWithHTTPClient creates a new PatchAPI24KMIPParams object
...
/*PatchAPI24KMIPParams contains all the parameters to send to the API endpoint
for the patch API 24 KMIP operation typically these are written to a http.Request
*/
...
func (o *PatchAPI24KMIPParams) WithContext(ctx context.Context) *PatchAPI24KMIPParams {
	o.SetContext(ctx)
	return o
}
...
func (o *PatchAPI24KMIPParams) WithKMIP(kmip *models.KMIPPatch) *PatchAPI24KMIPParams {
	o.SetKMIP(kmip)
	return o
}
