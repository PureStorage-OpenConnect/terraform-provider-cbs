...
// NewGetAPI24KMIPTestParams creates a new GetAPI24KMIPTestParams object
// with the default values initialized.
func NewGetAPI24KMIPTestParams() *GetAPI24KMIPTestParams {
	var ()
	return &GetAPI24KMIPTestParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24KMIPTestParamsWithTimeout creates a new GetAPI24KMIPTestParams object
...
// NewGetAPI24KMIPTestParamsWithContext creates a new GetAPI24KMIPTestParams object
...
// NewGetAPI24KMIPTestParamsWithHTTPClient creates a new GetAPI24KMIPTestParams object
...
/*GetAPI24KMIPTestParams contains all the parameters to send to the API endpoint
for the get API 24 KMIP test operation typically these are written to a http.Request
*/
...
func (o *GetAPI24KMIPTestParams) WithTimeout(timeout time.Duration) *GetAPI24KMIPTestParams {
...
func (o *GetAPI24KMIPTestParams) WithContext(ctx context.Context) *GetAPI24KMIPTestParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetAPI24KMIPTestParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
