...
// NewGetAPI24SNMPManagersTestParams creates a new GetAPI24SNMPManagersTestParams object
// with the default values initialized.
func NewGetAPI24SNMPManagersTestParams() *GetAPI24SNMPManagersTestParams {
	var ()
	return &GetAPI24SNMPManagersTestParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24SNMPManagersTestParamsWithTimeout creates a new GetAPI24SNMPManagersTestParams object
...
// NewGetAPI24SNMPManagersTestParamsWithContext creates a new GetAPI24SNMPManagersTestParams object
...
// NewGetAPI24SNMPManagersTestParamsWithHTTPClient creates a new GetAPI24SNMPManagersTestParams object
...
/*GetAPI24SNMPManagersTestParams contains all the parameters to send to the API endpoint
for the get API 24 SNMP managers test operation typically these are written to a http.Request
*/
...
func (o *GetAPI24SNMPManagersTestParams) WithTimeout(timeout time.Duration) *GetAPI24SNMPManagersTestParams {
...
func (o *GetAPI24SNMPManagersTestParams) WithContext(ctx context.Context) *GetAPI24SNMPManagersTestParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetAPI24SNMPManagersTestParams) WithHTTPClient(client *http.Client) *GetAPI24SNMPManagersTestParams {
...
func (o *GetAPI24SNMPManagersTestParams) WithXRequestID(xRequestID *string) *GetAPI24SNMPManagersTestParams {
...
func (o *GetAPI24SNMPManagersTestParams) WithFilter(filter *string) *GetAPI24SNMPManagersTestParams {
	o.SetFilter(filter)
	return o
}
...
func (o *GetAPI24SNMPManagersTestParams) WithLimit(limit *int32) *GetAPI24SNMPManagersTestParams {
	o.SetLimit(limit)
	return o
}
...
func (o *GetAPI24SNMPManagersTestParams) WithNames(names []string) *GetAPI24SNMPManagersTestParams {
	o.SetNames(names)
	return o
}
...
func (o *GetAPI24SNMPManagersTestParams) WithOffset(offset *int32) *GetAPI24SNMPManagersTestParams {
	o.SetOffset(offset)
	return o
}
...
func (o *GetAPI24SNMPManagersTestParams) WithSort(sort []string) *GetAPI24SNMPManagersTestParams {
	o.SetSort(sort)
	return o
}
...
func (o *GetAPI24SNMPManagersTestParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
