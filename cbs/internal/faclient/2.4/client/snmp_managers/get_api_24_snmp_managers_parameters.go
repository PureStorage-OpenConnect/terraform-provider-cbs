...
// NewGetAPI24SNMPManagersParams creates a new GetAPI24SNMPManagersParams object
// with the default values initialized.
func NewGetAPI24SNMPManagersParams() *GetAPI24SNMPManagersParams {
	var ()
	return &GetAPI24SNMPManagersParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24SNMPManagersParamsWithTimeout creates a new GetAPI24SNMPManagersParams object
...
// NewGetAPI24SNMPManagersParamsWithContext creates a new GetAPI24SNMPManagersParams object
...
// NewGetAPI24SNMPManagersParamsWithHTTPClient creates a new GetAPI24SNMPManagersParams object
...
/*GetAPI24SNMPManagersParams contains all the parameters to send to the API endpoint
for the get API 24 SNMP managers operation typically these are written to a http.Request
*/
...
func (o *GetAPI24SNMPManagersParams) WithTimeout(timeout time.Duration) *GetAPI24SNMPManagersParams {
...
func (o *GetAPI24SNMPManagersParams) WithContext(ctx context.Context) *GetAPI24SNMPManagersParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetAPI24SNMPManagersParams) WithHTTPClient(client *http.Client) *GetAPI24SNMPManagersParams {
...
func (o *GetAPI24SNMPManagersParams) WithFilter(filter *string) *GetAPI24SNMPManagersParams {
	o.SetFilter(filter)
	return o
}
...
func (o *GetAPI24SNMPManagersParams) WithLimit(limit *int32) *GetAPI24SNMPManagersParams {
	o.SetLimit(limit)
	return o
}
...
func (o *GetAPI24SNMPManagersParams) WithNames(names []string) *GetAPI24SNMPManagersParams {
	o.SetNames(names)
	return o
}
...
func (o *GetAPI24SNMPManagersParams) WithOffset(offset *int32) *GetAPI24SNMPManagersParams {
	o.SetOffset(offset)
	return o
}
...
func (o *GetAPI24SNMPManagersParams) WithSort(sort []string) *GetAPI24SNMPManagersParams {
	o.SetSort(sort)
	return o
}
...
func (o *GetAPI24SNMPManagersParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
