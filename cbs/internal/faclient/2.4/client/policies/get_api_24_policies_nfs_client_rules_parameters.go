...
// NewGetAPI24PoliciesNfsClientRulesParams creates a new GetAPI24PoliciesNfsClientRulesParams object
// with the default values initialized.
func NewGetAPI24PoliciesNfsClientRulesParams() *GetAPI24PoliciesNfsClientRulesParams {
	var ()
	return &GetAPI24PoliciesNfsClientRulesParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24PoliciesNfsClientRulesParamsWithTimeout creates a new GetAPI24PoliciesNfsClientRulesParams object
...
// NewGetAPI24PoliciesNfsClientRulesParamsWithContext creates a new GetAPI24PoliciesNfsClientRulesParams object
...
// NewGetAPI24PoliciesNfsClientRulesParamsWithHTTPClient creates a new GetAPI24PoliciesNfsClientRulesParams object
...
/*GetAPI24PoliciesNfsClientRulesParams contains all the parameters to send to the API endpoint
for the get API 24 policies nfs client rules operation typically these are written to a http.Request
*/
