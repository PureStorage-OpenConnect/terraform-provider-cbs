...
// NewGetAPI24AuditsParams creates a new GetAPI24AuditsParams object
// with the default values initialized.
func NewGetAPI24AuditsParams() *GetAPI24AuditsParams {
	var ()
	return &GetAPI24AuditsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24AuditsParamsWithTimeout creates a new GetAPI24AuditsParams object
...
// NewGetAPI24AuditsParamsWithContext creates a new GetAPI24AuditsParams object
...
// NewGetAPI24AuditsParamsWithHTTPClient creates a new GetAPI24AuditsParams object
...
/*GetAPI24AuditsParams contains all the parameters to send to the API endpoint
for the get API 24 audits operation typically these are written to a http.Request
*/
type GetAPI24AuditsParams struct {
