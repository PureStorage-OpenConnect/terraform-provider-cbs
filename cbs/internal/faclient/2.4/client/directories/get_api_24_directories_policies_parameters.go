...
// NewGetAPI24DirectoriesPoliciesParams creates a new GetAPI24DirectoriesPoliciesParams object
// with the default values initialized.
func NewGetAPI24DirectoriesPoliciesParams() *GetAPI24DirectoriesPoliciesParams {
	var ()
	return &GetAPI24DirectoriesPoliciesParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24DirectoriesPoliciesParamsWithTimeout creates a new GetAPI24DirectoriesPoliciesParams object
...
// NewGetAPI24DirectoriesPoliciesParamsWithContext creates a new GetAPI24DirectoriesPoliciesParams object
...
// NewGetAPI24DirectoriesPoliciesParamsWithHTTPClient creates a new GetAPI24DirectoriesPoliciesParams object
...
/*GetAPI24DirectoriesPoliciesParams contains all the parameters to send to the API endpoint
for the get API 24 directories policies operation typically these are written to a http.Request
*/
...
func (o *GetAPI24DirectoriesPoliciesParams) WithTimeout(timeout time.Duration) *GetAPI24DirectoriesPoliciesParams {
...
func (o *GetAPI24DirectoriesPoliciesParams) WithContext(ctx context.Context) *GetAPI24DirectoriesPoliciesParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get API 24 directories policies params
func (o *GetAPI24DirectoriesPoliciesParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get API 24 directories policies params
func (o *GetAPI24DirectoriesPoliciesParams) WithHTTPClient(client *http.Client) *GetAPI24DirectoriesPoliciesParams {
...
func (o *GetAPI24DirectoriesPoliciesParams) WithXRequestID(xRequestID *string) *GetAPI24DirectoriesPoliciesParams {
...
func (o *GetAPI24DirectoriesPoliciesParams) WithDestroyed(destroyed *bool) *GetAPI24DirectoriesPoliciesParams {
...
func (o *GetAPI24DirectoriesPoliciesParams) WithFilter(filter *string) *GetAPI24DirectoriesPoliciesParams {
	o.SetFilter(filter)
	return o
}
...
func (o *GetAPI24DirectoriesPoliciesParams) WithLimit(limit *int32) *GetAPI24DirectoriesPoliciesParams {
	o.SetLimit(limit)
	return o
}
...
func (o *GetAPI24DirectoriesPoliciesParams) WithMemberIds(memberIds []string) *GetAPI24DirectoriesPoliciesParams {
...
func (o *GetAPI24DirectoriesPoliciesParams) WithMemberNames(memberNames []string) *GetAPI24DirectoriesPoliciesParams {
...
func (o *GetAPI24DirectoriesPoliciesParams) WithOffset(offset *int32) *GetAPI24DirectoriesPoliciesParams {
	o.SetOffset(offset)
	return o
}
...
func (o *GetAPI24DirectoriesPoliciesParams) WithPolicyIds(policyIds []string) *GetAPI24DirectoriesPoliciesParams {
...
func (o *GetAPI24DirectoriesPoliciesParams) WithPolicyNames(policyNames []string) *GetAPI24DirectoriesPoliciesParams {
...
func (o *GetAPI24DirectoriesPoliciesParams) WithSort(sort []string) *GetAPI24DirectoriesPoliciesParams {
	o.SetSort(sort)
	return o
}
...
func (o *GetAPI24DirectoriesPoliciesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
