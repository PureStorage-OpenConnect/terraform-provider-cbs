...
// NewGetAPI24HostGroupsParams creates a new GetAPI24HostGroupsParams object
// with the default values initialized.
func NewGetAPI24HostGroupsParams() *GetAPI24HostGroupsParams {
	var ()
	return &GetAPI24HostGroupsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24HostGroupsParamsWithTimeout creates a new GetAPI24HostGroupsParams object
...
// NewGetAPI24HostGroupsParamsWithContext creates a new GetAPI24HostGroupsParams object
...
// NewGetAPI24HostGroupsParamsWithHTTPClient creates a new GetAPI24HostGroupsParams object
...
/*GetAPI24HostGroupsParams contains all the parameters to send to the API endpoint
for the get API 24 host groups operation typically these are written to a http.Request
*/
