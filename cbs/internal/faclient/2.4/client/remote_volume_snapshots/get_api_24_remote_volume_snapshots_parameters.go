...
// NewGetAPI24RemoteVolumeSnapshotsParams creates a new GetAPI24RemoteVolumeSnapshotsParams object
// with the default values initialized.
func NewGetAPI24RemoteVolumeSnapshotsParams() *GetAPI24RemoteVolumeSnapshotsParams {
	var ()
	return &GetAPI24RemoteVolumeSnapshotsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24RemoteVolumeSnapshotsParamsWithTimeout creates a new GetAPI24RemoteVolumeSnapshotsParams object
...
// NewGetAPI24RemoteVolumeSnapshotsParamsWithContext creates a new GetAPI24RemoteVolumeSnapshotsParams object
...
// NewGetAPI24RemoteVolumeSnapshotsParamsWithHTTPClient creates a new GetAPI24RemoteVolumeSnapshotsParams object
...
/*GetAPI24RemoteVolumeSnapshotsParams contains all the parameters to send to the API endpoint
for the get API 24 remote volume snapshots operation typically these are written to a http.Request
*/
...
func (o *GetAPI24RemoteVolumeSnapshotsParams) WithTimeout(timeout time.Duration) *GetAPI24RemoteVolumeSnapshotsParams {
...
func (o *GetAPI24RemoteVolumeSnapshotsParams) WithContext(ctx context.Context) *GetAPI24RemoteVolumeSnapshotsParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get API 24 remote volume snapshots params
func (o *GetAPI24RemoteVolumeSnapshotsParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get API 24 remote volume snapshots params
func (o *GetAPI24RemoteVolumeSnapshotsParams) WithHTTPClient(client *http.Client) *GetAPI24RemoteVolumeSnapshotsParams {
...
func (o *GetAPI24RemoteVolumeSnapshotsParams) WithAuthorization(authorization *string) *GetAPI24RemoteVolumeSnapshotsParams {
...
func (o *GetAPI24RemoteVolumeSnapshotsParams) WithXRequestID(xRequestID *string) *GetAPI24RemoteVolumeSnapshotsParams {
...
func (o *GetAPI24RemoteVolumeSnapshotsParams) WithDestroyed(destroyed *bool) *GetAPI24RemoteVolumeSnapshotsParams {
...
func (o *GetAPI24RemoteVolumeSnapshotsParams) WithFilter(filter *string) *GetAPI24RemoteVolumeSnapshotsParams {
	o.SetFilter(filter)
	return o
}
...
func (o *GetAPI24RemoteVolumeSnapshotsParams) WithIds(ids []string) *GetAPI24RemoteVolumeSnapshotsParams {
	o.SetIds(ids)
	return o
}

// SetIds adds the ids to the get API 24 remote volume snapshots params
func (o *GetAPI24RemoteVolumeSnapshotsParams) SetIds(ids []string) {
	o.Ids = ids
}

// WithLimit adds the limit to the get API 24 remote volume snapshots params
func (o *GetAPI24RemoteVolumeSnapshotsParams) WithLimit(limit *int32) *GetAPI24RemoteVolumeSnapshotsParams {
	o.SetLimit(limit)
	return o
}
...
func (o *GetAPI24RemoteVolumeSnapshotsParams) WithNames(names []string) *GetAPI24RemoteVolumeSnapshotsParams {
	o.SetNames(names)
	return o
}
...
func (o *GetAPI24RemoteVolumeSnapshotsParams) WithOffset(offset *int32) *GetAPI24RemoteVolumeSnapshotsParams {
	o.SetOffset(offset)
	return o
}
...
func (o *GetAPI24RemoteVolumeSnapshotsParams) WithOn(on []string) *GetAPI24RemoteVolumeSnapshotsParams {
	o.SetOn(on)
	return o
}

// SetOn adds the on to the get API 24 remote volume snapshots params
func (o *GetAPI24RemoteVolumeSnapshotsParams) SetOn(on []string) {
	o.On = on
}

// WithSort adds the sort to the get API 24 remote volume snapshots params
func (o *GetAPI24RemoteVolumeSnapshotsParams) WithSort(sort []string) *GetAPI24RemoteVolumeSnapshotsParams {
	o.SetSort(sort)
	return o
}
...
func (o *GetAPI24RemoteVolumeSnapshotsParams) WithSourceIds(sourceIds []string) *GetAPI24RemoteVolumeSnapshotsParams {
...
func (o *GetAPI24RemoteVolumeSnapshotsParams) WithSourceNames(sourceNames []string) *GetAPI24RemoteVolumeSnapshotsParams {
...
func (o *GetAPI24RemoteVolumeSnapshotsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
