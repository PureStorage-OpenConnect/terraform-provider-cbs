...
// NewGetAPI24RemoteVolumeSnapshotsTransferParams creates a new GetAPI24RemoteVolumeSnapshotsTransferParams object
// with the default values initialized.
func NewGetAPI24RemoteVolumeSnapshotsTransferParams() *GetAPI24RemoteVolumeSnapshotsTransferParams {
	var ()
	return &GetAPI24RemoteVolumeSnapshotsTransferParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24RemoteVolumeSnapshotsTransferParamsWithTimeout creates a new GetAPI24RemoteVolumeSnapshotsTransferParams object
...
// NewGetAPI24RemoteVolumeSnapshotsTransferParamsWithContext creates a new GetAPI24RemoteVolumeSnapshotsTransferParams object
...
// NewGetAPI24RemoteVolumeSnapshotsTransferParamsWithHTTPClient creates a new GetAPI24RemoteVolumeSnapshotsTransferParams object
...
/*GetAPI24RemoteVolumeSnapshotsTransferParams contains all the parameters to send to the API endpoint
for the get API 24 remote volume snapshots transfer operation typically these are written to a http.Request
*/
...
func (o *GetAPI24RemoteVolumeSnapshotsTransferParams) WithTimeout(timeout time.Duration) *GetAPI24RemoteVolumeSnapshotsTransferParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the get API 24 remote volume snapshots transfer params
func (o *GetAPI24RemoteVolumeSnapshotsTransferParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the get API 24 remote volume snapshots transfer params
func (o *GetAPI24RemoteVolumeSnapshotsTransferParams) WithContext(ctx context.Context) *GetAPI24RemoteVolumeSnapshotsTransferParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get API 24 remote volume snapshots transfer params
func (o *GetAPI24RemoteVolumeSnapshotsTransferParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get API 24 remote volume snapshots transfer params
func (o *GetAPI24RemoteVolumeSnapshotsTransferParams) WithHTTPClient(client *http.Client) *GetAPI24RemoteVolumeSnapshotsTransferParams {
...
func (o *GetAPI24RemoteVolumeSnapshotsTransferParams) WithAuthorization(authorization *string) *GetAPI24RemoteVolumeSnapshotsTransferParams {
...
func (o *GetAPI24RemoteVolumeSnapshotsTransferParams) WithXRequestID(xRequestID *string) *GetAPI24RemoteVolumeSnapshotsTransferParams {
...
func (o *GetAPI24RemoteVolumeSnapshotsTransferParams) WithDestroyed(destroyed *bool) *GetAPI24RemoteVolumeSnapshotsTransferParams {
...
func (o *GetAPI24RemoteVolumeSnapshotsTransferParams) WithFilter(filter *string) *GetAPI24RemoteVolumeSnapshotsTransferParams {
	o.SetFilter(filter)
	return o
}

// SetFilter adds the filter to the get API 24 remote volume snapshots transfer params
func (o *GetAPI24RemoteVolumeSnapshotsTransferParams) SetFilter(filter *string) {
	o.Filter = filter
}

// WithIds adds the ids to the get API 24 remote volume snapshots transfer params
func (o *GetAPI24RemoteVolumeSnapshotsTransferParams) WithIds(ids []string) *GetAPI24RemoteVolumeSnapshotsTransferParams {
	o.SetIds(ids)
	return o
}

// SetIds adds the ids to the get API 24 remote volume snapshots transfer params
func (o *GetAPI24RemoteVolumeSnapshotsTransferParams) SetIds(ids []string) {
	o.Ids = ids
}

// WithLimit adds the limit to the get API 24 remote volume snapshots transfer params
func (o *GetAPI24RemoteVolumeSnapshotsTransferParams) WithLimit(limit *int32) *GetAPI24RemoteVolumeSnapshotsTransferParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the get API 24 remote volume snapshots transfer params
func (o *GetAPI24RemoteVolumeSnapshotsTransferParams) SetLimit(limit *int32) {
	o.Limit = limit
}

// WithNames adds the names to the get API 24 remote volume snapshots transfer params
func (o *GetAPI24RemoteVolumeSnapshotsTransferParams) WithNames(names []string) *GetAPI24RemoteVolumeSnapshotsTransferParams {
	o.SetNames(names)
	return o
}

// SetNames adds the names to the get API 24 remote volume snapshots transfer params
func (o *GetAPI24RemoteVolumeSnapshotsTransferParams) SetNames(names []string) {
	o.Names = names
}

// WithOffset adds the offset to the get API 24 remote volume snapshots transfer params
func (o *GetAPI24RemoteVolumeSnapshotsTransferParams) WithOffset(offset *int32) *GetAPI24RemoteVolumeSnapshotsTransferParams {
	o.SetOffset(offset)
	return o
}
...
func (o *GetAPI24RemoteVolumeSnapshotsTransferParams) WithOn(on []string) *GetAPI24RemoteVolumeSnapshotsTransferParams {
	o.SetOn(on)
	return o
}

// SetOn adds the on to the get API 24 remote volume snapshots transfer params
func (o *GetAPI24RemoteVolumeSnapshotsTransferParams) SetOn(on []string) {
	o.On = on
}

// WithSort adds the sort to the get API 24 remote volume snapshots transfer params
func (o *GetAPI24RemoteVolumeSnapshotsTransferParams) WithSort(sort []string) *GetAPI24RemoteVolumeSnapshotsTransferParams {
	o.SetSort(sort)
	return o
}

// SetSort adds the sort to the get API 24 remote volume snapshots transfer params
func (o *GetAPI24RemoteVolumeSnapshotsTransferParams) SetSort(sort []string) {
	o.Sort = sort
}

// WithSourceIds adds the sourceIds to the get API 24 remote volume snapshots transfer params
func (o *GetAPI24RemoteVolumeSnapshotsTransferParams) WithSourceIds(sourceIds []string) *GetAPI24RemoteVolumeSnapshotsTransferParams {
...
func (o *GetAPI24RemoteVolumeSnapshotsTransferParams) WithSourceNames(sourceNames []string) *GetAPI24RemoteVolumeSnapshotsTransferParams {
...
func (o *GetAPI24RemoteVolumeSnapshotsTransferParams) WithTotalItemCount(totalItemCount *bool) *GetAPI24RemoteVolumeSnapshotsTransferParams {
...
func (o *GetAPI24RemoteVolumeSnapshotsTransferParams) WithTotalOnly(totalOnly *bool) *GetAPI24RemoteVolumeSnapshotsTransferParams {
...
func (o *GetAPI24RemoteVolumeSnapshotsTransferParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
