...
// NewGetAPI24DrivesParams creates a new GetAPI24DrivesParams object
// with the default values initialized.
func NewGetAPI24DrivesParams() *GetAPI24DrivesParams {
	var ()
	return &GetAPI24DrivesParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24DrivesParamsWithTimeout creates a new GetAPI24DrivesParams object
...
// NewGetAPI24DrivesParamsWithContext creates a new GetAPI24DrivesParams object
...
// NewGetAPI24DrivesParamsWithHTTPClient creates a new GetAPI24DrivesParams object
...
/*GetAPI24DrivesParams contains all the parameters to send to the API endpoint
for the get API 24 drives operation typically these are written to a http.Request
*/
...
func (o *GetAPI24DrivesParams) WithContext(ctx context.Context) *GetAPI24DrivesParams {
	o.SetContext(ctx)
	return o
}
