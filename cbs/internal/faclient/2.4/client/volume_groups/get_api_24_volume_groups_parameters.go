...
// NewGetAPI24VolumeGroupsParams creates a new GetAPI24VolumeGroupsParams object
// with the default values initialized.
func NewGetAPI24VolumeGroupsParams() *GetAPI24VolumeGroupsParams {
	var ()
	return &GetAPI24VolumeGroupsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24VolumeGroupsParamsWithTimeout creates a new GetAPI24VolumeGroupsParams object
...
// NewGetAPI24VolumeGroupsParamsWithContext creates a new GetAPI24VolumeGroupsParams object
...
// NewGetAPI24VolumeGroupsParamsWithHTTPClient creates a new GetAPI24VolumeGroupsParams object
...
/*GetAPI24VolumeGroupsParams contains all the parameters to send to the API endpoint
for the get API 24 volume groups operation typically these are written to a http.Request
*/
...
func (o *GetAPI24VolumeGroupsParams) WithTimeout(timeout time.Duration) *GetAPI24VolumeGroupsParams {
...
func (o *GetAPI24VolumeGroupsParams) WithContext(ctx context.Context) *GetAPI24VolumeGroupsParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetAPI24VolumeGroupsParams) WithHTTPClient(client *http.Client) *GetAPI24VolumeGroupsParams {
...
func (o *GetAPI24VolumeGroupsParams) WithFilter(filter *string) *GetAPI24VolumeGroupsParams {
	o.SetFilter(filter)
	return o
}
...
func (o *GetAPI24VolumeGroupsParams) WithIds(ids []string) *GetAPI24VolumeGroupsParams {
	o.SetIds(ids)
	return o
}
...
func (o *GetAPI24VolumeGroupsParams) WithLimit(limit *int32) *GetAPI24VolumeGroupsParams {
	o.SetLimit(limit)
	return o
}
...
func (o *GetAPI24VolumeGroupsParams) WithNames(names []string) *GetAPI24VolumeGroupsParams {
	o.SetNames(names)
	return o
}
...
func (o *GetAPI24VolumeGroupsParams) WithOffset(offset *int32) *GetAPI24VolumeGroupsParams {
	o.SetOffset(offset)
	return o
}
...
func (o *GetAPI24VolumeGroupsParams) WithSort(sort []string) *GetAPI24VolumeGroupsParams {
	o.SetSort(sort)
	return o
}
...
func (o *GetAPI24VolumeGroupsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
