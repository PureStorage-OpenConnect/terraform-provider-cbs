...
// NewGetAPI24VolumeGroupsPerformanceParams creates a new GetAPI24VolumeGroupsPerformanceParams object
// with the default values initialized.
func NewGetAPI24VolumeGroupsPerformanceParams() *GetAPI24VolumeGroupsPerformanceParams {
	var ()
	return &GetAPI24VolumeGroupsPerformanceParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24VolumeGroupsPerformanceParamsWithTimeout creates a new GetAPI24VolumeGroupsPerformanceParams object
...
// NewGetAPI24VolumeGroupsPerformanceParamsWithContext creates a new GetAPI24VolumeGroupsPerformanceParams object
...
// NewGetAPI24VolumeGroupsPerformanceParamsWithHTTPClient creates a new GetAPI24VolumeGroupsPerformanceParams object
...
/*GetAPI24VolumeGroupsPerformanceParams contains all the parameters to send to the API endpoint
for the get API 24 volume groups performance operation typically these are written to a http.Request
*/
...
func (o *GetAPI24VolumeGroupsPerformanceParams) WithTimeout(timeout time.Duration) *GetAPI24VolumeGroupsPerformanceParams {
...
func (o *GetAPI24VolumeGroupsPerformanceParams) WithContext(ctx context.Context) *GetAPI24VolumeGroupsPerformanceParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get API 24 volume groups performance params
func (o *GetAPI24VolumeGroupsPerformanceParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get API 24 volume groups performance params
func (o *GetAPI24VolumeGroupsPerformanceParams) WithHTTPClient(client *http.Client) *GetAPI24VolumeGroupsPerformanceParams {
...
func (o *GetAPI24VolumeGroupsPerformanceParams) WithAuthorization(authorization *string) *GetAPI24VolumeGroupsPerformanceParams {
...
func (o *GetAPI24VolumeGroupsPerformanceParams) WithXRequestID(xRequestID *string) *GetAPI24VolumeGroupsPerformanceParams {
...
func (o *GetAPI24VolumeGroupsPerformanceParams) WithDestroyed(destroyed *bool) *GetAPI24VolumeGroupsPerformanceParams {
...
func (o *GetAPI24VolumeGroupsPerformanceParams) WithEndTime(endTime *int64) *GetAPI24VolumeGroupsPerformanceParams {
...
func (o *GetAPI24VolumeGroupsPerformanceParams) WithFilter(filter *string) *GetAPI24VolumeGroupsPerformanceParams {
	o.SetFilter(filter)
	return o
}
...
func (o *GetAPI24VolumeGroupsPerformanceParams) WithIds(ids []string) *GetAPI24VolumeGroupsPerformanceParams {
	o.SetIds(ids)
	return o
}

// SetIds adds the ids to the get API 24 volume groups performance params
func (o *GetAPI24VolumeGroupsPerformanceParams) SetIds(ids []string) {
	o.Ids = ids
}

// WithLimit adds the limit to the get API 24 volume groups performance params
func (o *GetAPI24VolumeGroupsPerformanceParams) WithLimit(limit *int32) *GetAPI24VolumeGroupsPerformanceParams {
	o.SetLimit(limit)
	return o
}
...
func (o *GetAPI24VolumeGroupsPerformanceParams) WithNames(names []string) *GetAPI24VolumeGroupsPerformanceParams {
	o.SetNames(names)
	return o
}
...
func (o *GetAPI24VolumeGroupsPerformanceParams) WithOffset(offset *int32) *GetAPI24VolumeGroupsPerformanceParams {
	o.SetOffset(offset)
	return o
}
...
func (o *GetAPI24VolumeGroupsPerformanceParams) WithResolution(resolution *int64) *GetAPI24VolumeGroupsPerformanceParams {
...
func (o *GetAPI24VolumeGroupsPerformanceParams) WithSort(sort []string) *GetAPI24VolumeGroupsPerformanceParams {
	o.SetSort(sort)
	return o
}
...
func (o *GetAPI24VolumeGroupsPerformanceParams) WithStartTime(startTime *int64) *GetAPI24VolumeGroupsPerformanceParams {
...
func (o *GetAPI24VolumeGroupsPerformanceParams) WithTotalItemCount(totalItemCount *bool) *GetAPI24VolumeGroupsPerformanceParams {
...
func (o *GetAPI24VolumeGroupsPerformanceParams) WithTotalOnly(totalOnly *bool) *GetAPI24VolumeGroupsPerformanceParams {
...
func (o *GetAPI24VolumeGroupsPerformanceParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
