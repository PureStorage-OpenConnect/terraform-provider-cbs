...
// NewGetAPI24VolumeGroupsVolumesParams creates a new GetAPI24VolumeGroupsVolumesParams object
// with the default values initialized.
func NewGetAPI24VolumeGroupsVolumesParams() *GetAPI24VolumeGroupsVolumesParams {
	var ()
	return &GetAPI24VolumeGroupsVolumesParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24VolumeGroupsVolumesParamsWithTimeout creates a new GetAPI24VolumeGroupsVolumesParams object
...
// NewGetAPI24VolumeGroupsVolumesParamsWithContext creates a new GetAPI24VolumeGroupsVolumesParams object
...
// NewGetAPI24VolumeGroupsVolumesParamsWithHTTPClient creates a new GetAPI24VolumeGroupsVolumesParams object
...
/*GetAPI24VolumeGroupsVolumesParams contains all the parameters to send to the API endpoint
for the get API 24 volume groups volumes operation typically these are written to a http.Request
*/
...
func (o *GetAPI24VolumeGroupsVolumesParams) WithTimeout(timeout time.Duration) *GetAPI24VolumeGroupsVolumesParams {
...
func (o *GetAPI24VolumeGroupsVolumesParams) WithContext(ctx context.Context) *GetAPI24VolumeGroupsVolumesParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get API 24 volume groups volumes params
func (o *GetAPI24VolumeGroupsVolumesParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get API 24 volume groups volumes params
func (o *GetAPI24VolumeGroupsVolumesParams) WithHTTPClient(client *http.Client) *GetAPI24VolumeGroupsVolumesParams {
...
func (o *GetAPI24VolumeGroupsVolumesParams) WithXRequestID(xRequestID *string) *GetAPI24VolumeGroupsVolumesParams {
...
func (o *GetAPI24VolumeGroupsVolumesParams) WithFilter(filter *string) *GetAPI24VolumeGroupsVolumesParams {
	o.SetFilter(filter)
	return o
}
...
func (o *GetAPI24VolumeGroupsVolumesParams) WithGroupIds(groupIds []string) *GetAPI24VolumeGroupsVolumesParams {
...
func (o *GetAPI24VolumeGroupsVolumesParams) WithGroupNames(groupNames []string) *GetAPI24VolumeGroupsVolumesParams {
...
func (o *GetAPI24VolumeGroupsVolumesParams) WithLimit(limit *int32) *GetAPI24VolumeGroupsVolumesParams {
	o.SetLimit(limit)
	return o
}
...
func (o *GetAPI24VolumeGroupsVolumesParams) WithMemberIds(memberIds []string) *GetAPI24VolumeGroupsVolumesParams {
...
func (o *GetAPI24VolumeGroupsVolumesParams) WithMemberNames(memberNames []string) *GetAPI24VolumeGroupsVolumesParams {
...
func (o *GetAPI24VolumeGroupsVolumesParams) WithOffset(offset *int32) *GetAPI24VolumeGroupsVolumesParams {
	o.SetOffset(offset)
	return o
}
...
func (o *GetAPI24VolumeGroupsVolumesParams) WithSort(sort []string) *GetAPI24VolumeGroupsVolumesParams {
	o.SetSort(sort)
	return o
}
...
func (o *GetAPI24VolumeGroupsVolumesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
