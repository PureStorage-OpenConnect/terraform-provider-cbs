...
// NewGetAPI24RemoteProtectionGroupSnapshotsTransferParams creates a new GetAPI24RemoteProtectionGroupSnapshotsTransferParams object
// with the default values initialized.
func NewGetAPI24RemoteProtectionGroupSnapshotsTransferParams() *GetAPI24RemoteProtectionGroupSnapshotsTransferParams {
	var ()
	return &GetAPI24RemoteProtectionGroupSnapshotsTransferParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPI24RemoteProtectionGroupSnapshotsTransferParamsWithTimeout creates a new GetAPI24RemoteProtectionGroupSnapshotsTransferParams object
...
// NewGetAPI24RemoteProtectionGroupSnapshotsTransferParamsWithContext creates a new GetAPI24RemoteProtectionGroupSnapshotsTransferParams object
...
// NewGetAPI24RemoteProtectionGroupSnapshotsTransferParamsWithHTTPClient creates a new GetAPI24RemoteProtectionGroupSnapshotsTransferParams object
...
/*GetAPI24RemoteProtectionGroupSnapshotsTransferParams contains all the parameters to send to the API endpoint
for the get API 24 remote protection group snapshots transfer operation typically these are written to a http.Request
*/
...
func (o *GetAPI24RemoteProtectionGroupSnapshotsTransferParams) WithTimeout(timeout time.Duration) *GetAPI24RemoteProtectionGroupSnapshotsTransferParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the get API 24 remote protection group snapshots transfer params
func (o *GetAPI24RemoteProtectionGroupSnapshotsTransferParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the get API 24 remote protection group snapshots transfer params
func (o *GetAPI24RemoteProtectionGroupSnapshotsTransferParams) WithContext(ctx context.Context) *GetAPI24RemoteProtectionGroupSnapshotsTransferParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get API 24 remote protection group snapshots transfer params
func (o *GetAPI24RemoteProtectionGroupSnapshotsTransferParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get API 24 remote protection group snapshots transfer params
func (o *GetAPI24RemoteProtectionGroupSnapshotsTransferParams) WithHTTPClient(client *http.Client) *GetAPI24RemoteProtectionGroupSnapshotsTransferParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the get API 24 remote protection group snapshots transfer params
func (o *GetAPI24RemoteProtectionGroupSnapshotsTransferParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithAuthorization adds the authorization to the get API 24 remote protection group snapshots transfer params
func (o *GetAPI24RemoteProtectionGroupSnapshotsTransferParams) WithAuthorization(authorization *string) *GetAPI24RemoteProtectionGroupSnapshotsTransferParams {
...
func (o *GetAPI24RemoteProtectionGroupSnapshotsTransferParams) WithXRequestID(xRequestID *string) *GetAPI24RemoteProtectionGroupSnapshotsTransferParams {
...
func (o *GetAPI24RemoteProtectionGroupSnapshotsTransferParams) WithDestroyed(destroyed *bool) *GetAPI24RemoteProtectionGroupSnapshotsTransferParams {
...
func (o *GetAPI24RemoteProtectionGroupSnapshotsTransferParams) WithFilter(filter *string) *GetAPI24RemoteProtectionGroupSnapshotsTransferParams {
	o.SetFilter(filter)
	return o
}

// SetFilter adds the filter to the get API 24 remote protection group snapshots transfer params
func (o *GetAPI24RemoteProtectionGroupSnapshotsTransferParams) SetFilter(filter *string) {
	o.Filter = filter
}

// WithLimit adds the limit to the get API 24 remote protection group snapshots transfer params
func (o *GetAPI24RemoteProtectionGroupSnapshotsTransferParams) WithLimit(limit *int32) *GetAPI24RemoteProtectionGroupSnapshotsTransferParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the get API 24 remote protection group snapshots transfer params
func (o *GetAPI24RemoteProtectionGroupSnapshotsTransferParams) SetLimit(limit *int32) {
	o.Limit = limit
}

// WithNames adds the names to the get API 24 remote protection group snapshots transfer params
func (o *GetAPI24RemoteProtectionGroupSnapshotsTransferParams) WithNames(names []string) *GetAPI24RemoteProtectionGroupSnapshotsTransferParams {
	o.SetNames(names)
	return o
}

// SetNames adds the names to the get API 24 remote protection group snapshots transfer params
func (o *GetAPI24RemoteProtectionGroupSnapshotsTransferParams) SetNames(names []string) {
	o.Names = names
}

// WithOffset adds the offset to the get API 24 remote protection group snapshots transfer params
func (o *GetAPI24RemoteProtectionGroupSnapshotsTransferParams) WithOffset(offset *int32) *GetAPI24RemoteProtectionGroupSnapshotsTransferParams {
	o.SetOffset(offset)
	return o
}

// SetOffset adds the offset to the get API 24 remote protection group snapshots transfer params
func (o *GetAPI24RemoteProtectionGroupSnapshotsTransferParams) SetOffset(offset *int32) {
	o.Offset = offset
}

// WithOn adds the on to the get API 24 remote protection group snapshots transfer params
func (o *GetAPI24RemoteProtectionGroupSnapshotsTransferParams) WithOn(on []string) *GetAPI24RemoteProtectionGroupSnapshotsTransferParams {
	o.SetOn(on)
	return o
}

// SetOn adds the on to the get API 24 remote protection group snapshots transfer params
func (o *GetAPI24RemoteProtectionGroupSnapshotsTransferParams) SetOn(on []string) {
	o.On = on
}

// WithSort adds the sort to the get API 24 remote protection group snapshots transfer params
func (o *GetAPI24RemoteProtectionGroupSnapshotsTransferParams) WithSort(sort []string) *GetAPI24RemoteProtectionGroupSnapshotsTransferParams {
	o.SetSort(sort)
	return o
}

// SetSort adds the sort to the get API 24 remote protection group snapshots transfer params
func (o *GetAPI24RemoteProtectionGroupSnapshotsTransferParams) SetSort(sort []string) {
	o.Sort = sort
}

// WithSourceNames adds the sourceNames to the get API 24 remote protection group snapshots transfer params
func (o *GetAPI24RemoteProtectionGroupSnapshotsTransferParams) WithSourceNames(sourceNames []string) *GetAPI24RemoteProtectionGroupSnapshotsTransferParams {
...
func (o *GetAPI24RemoteProtectionGroupSnapshotsTransferParams) WithTotalItemCount(totalItemCount *bool) *GetAPI24RemoteProtectionGroupSnapshotsTransferParams {
...
func (o *GetAPI24RemoteProtectionGroupSnapshotsTransferParams) WithTotalOnly(totalOnly *bool) *GetAPI24RemoteProtectionGroupSnapshotsTransferParams {
...
func (o *GetAPI24RemoteProtectionGroupSnapshotsTransferParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
