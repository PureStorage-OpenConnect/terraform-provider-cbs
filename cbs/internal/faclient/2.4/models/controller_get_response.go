...
func (m *ControllerGetResponse) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 ControllerGetResponseAllOf1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.ControllerGetResponseAllOf1 = aO1
...
func (m ControllerGetResponse) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.ControllerGetResponseAllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *ControllerGetResponse) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with ControllerGetResponseAllOf1
	if err := m.ControllerGetResponseAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
