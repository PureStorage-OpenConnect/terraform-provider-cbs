...
func (m ProtectionGroupOAIGenAllOf1TargetRetention) MarshalJSON() ([]byte, error) {
...
func (m *ProtectionGroupOAIGenAllOf1TargetRetention) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ProtectionGroupOAIGenAllOf1TargetRetention) UnmarshalBinary(b []byte) error {
	var res ProtectionGroupOAIGenAllOf1TargetRetention
