...
func (m *CertificateSigningRequestResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CertificateSigningRequestResponse) validateItems(formats strfmt.Registry) error {
...
func (m *CertificateSigningRequestResponse) UnmarshalBinary(b []byte) error {
	var res CertificateSigningRequestResponse
