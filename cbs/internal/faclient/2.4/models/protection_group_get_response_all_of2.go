...
func (m *ProtectionGroupGetResponseAllOf2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ProtectionGroupGetResponseAllOf2) validateTotal(formats strfmt.Registry) error {
...
func (m *ProtectionGroupGetResponseAllOf2) UnmarshalBinary(b []byte) error {
	var res ProtectionGroupGetResponseAllOf2
