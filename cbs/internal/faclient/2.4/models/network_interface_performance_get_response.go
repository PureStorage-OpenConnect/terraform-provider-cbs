...
func (m *NetworkInterfacePerformanceGetResponse) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 NetworkInterfacePerformanceGetResponseAllOf1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.NetworkInterfacePerformanceGetResponseAllOf1 = aO1
...
func (m NetworkInterfacePerformanceGetResponse) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.NetworkInterfacePerformanceGetResponseAllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *NetworkInterfacePerformanceGetResponse) Validate(formats strfmt.Registry) error {
	var res []error
	...
	// validation for a type composition with NetworkInterfacePerformanceGetResponseAllOf1
	if err := m.NetworkInterfacePerformanceGetResponseAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
...
func (m *NetworkInterfacePerformanceGetResponse) UnmarshalBinary(b []byte) error {
	var res NetworkInterfacePerformanceGetResponse
