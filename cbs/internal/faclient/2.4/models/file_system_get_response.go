...
func (m *FileSystemGetResponse) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 FileSystemResponse
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.FileSystemResponse = aO1
...
func (m FileSystemGetResponse) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.FileSystemResponse)
	if err != nil {
		return nil, err
	}
...
func (m *FileSystemGetResponse) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with FileSystemResponse
