...
func (m *PodPerformanceReplicationGetResponse) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 PodPerformanceReplicationResponse
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.PodPerformanceReplicationResponse = aO1
...
func (m PodPerformanceReplicationGetResponse) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.PodPerformanceReplicationResponse)
	if err != nil {
		return nil, err
	}
...
func (m *PodPerformanceReplicationGetResponse) Validate(formats strfmt.Registry) error {
	var res []error
	...
	// validation for a type composition with PodPerformanceReplicationResponse
	if err := m.PodPerformanceReplicationResponse.Validate(formats); err != nil {
		res = append(res, err)
	}
...
func (m *PodPerformanceReplicationGetResponse) UnmarshalBinary(b []byte) error {
	var res PodPerformanceReplicationGetResponse
