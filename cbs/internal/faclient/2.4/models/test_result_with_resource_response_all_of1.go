...
func (m *TestResultWithResourceResponseAllOf1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TestResultWithResourceResponseAllOf1) validateItems(formats strfmt.Registry) error {
...
func (m *TestResultWithResourceResponseAllOf1) UnmarshalBinary(b []byte) error {
	var res TestResultWithResourceResponseAllOf1
