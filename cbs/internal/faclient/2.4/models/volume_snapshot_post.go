...
func (m *VolumeSnapshotPost) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 VolumeSnapshotPostAllOf1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.VolumeSnapshotPostAllOf1 = aO1
...
func (m VolumeSnapshotPost) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.VolumeSnapshotPostAllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *VolumeSnapshotPost) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with VolumeSnapshotPostAllOf1
	if err := m.VolumeSnapshotPostAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
