...
func (m *PortInitiatorsGetResponse) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 PortInitiatorsGetResponseAllOf1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.PortInitiatorsGetResponseAllOf1 = aO1
...
func (m PortInitiatorsGetResponse) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.PortInitiatorsGetResponseAllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *PortInitiatorsGetResponse) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with PortInitiatorsGetResponseAllOf1
	if err := m.PortInitiatorsGetResponseAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
...
func (m *PortInitiatorsGetResponse) UnmarshalBinary(b []byte) error {
	var res PortInitiatorsGetResponse
