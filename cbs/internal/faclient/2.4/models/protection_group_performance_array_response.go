...
func (m *ProtectionGroupPerformanceArrayResponse) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 ProtectionGroupPerformanceArrayResponseAllOf1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.ProtectionGroupPerformanceArrayResponseAllOf1 = aO1
...
func (m ProtectionGroupPerformanceArrayResponse) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.ProtectionGroupPerformanceArrayResponseAllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *ProtectionGroupPerformanceArrayResponse) Validate(formats strfmt.Registry) error {
	var res []error
	...
	// validation for a type composition with ProtectionGroupPerformanceArrayResponseAllOf1
	if err := m.ProtectionGroupPerformanceArrayResponseAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
...
func (m *ProtectionGroupPerformanceArrayResponse) UnmarshalBinary(b []byte) error {
	var res ProtectionGroupPerformanceArrayResponse
