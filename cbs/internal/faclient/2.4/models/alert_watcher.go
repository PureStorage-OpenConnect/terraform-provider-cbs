...
func (m *AlertWatcher) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 AlertWatcherOAIGenAllOf1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.AlertWatcherOAIGenAllOf1 = aO1
...
func (m AlertWatcher) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.AlertWatcherOAIGenAllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *AlertWatcher) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with AlertWatcherOAIGenAllOf1
	if err := m.AlertWatcherOAIGenAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
