...
func (m *VolumeCommon) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 VolumeCommonAllOf1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.VolumeCommonAllOf1 = aO1
...
func (m VolumeCommon) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.VolumeCommonAllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *VolumeCommon) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with VolumeCommonAllOf1
	if err := m.VolumeCommonAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
