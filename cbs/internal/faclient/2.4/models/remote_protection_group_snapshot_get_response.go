...
func (m *RemoteProtectionGroupSnapshotGetResponse) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 RemoteProtectionGroupSnapshotResponse
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.RemoteProtectionGroupSnapshotResponse = aO1

	return nil
}

// MarshalJSON marshals this object to a JSON structure
func (m RemoteProtectionGroupSnapshotGetResponse) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.RemoteProtectionGroupSnapshotResponse)
	if err != nil {
		return nil, err
	}
...
func (m *RemoteProtectionGroupSnapshotGetResponse) Validate(formats strfmt.Registry) error {
	var res []error
	...
	// validation for a type composition with RemoteProtectionGroupSnapshotResponse
	if err := m.RemoteProtectionGroupSnapshotResponse.Validate(formats); err != nil {
		res = append(res, err)
	}
...
func (m *RemoteProtectionGroupSnapshotGetResponse) UnmarshalBinary(b []byte) error {
	var res RemoteProtectionGroupSnapshotGetResponse
