...
func (m *ProtectionGroupSnapshotGetResponseAllOf2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ProtectionGroupSnapshotGetResponseAllOf2) validateTotal(formats strfmt.Registry) error {
...
func (m *ProtectionGroupSnapshotGetResponseAllOf2) UnmarshalBinary(b []byte) error {
	var res ProtectionGroupSnapshotGetResponseAllOf2
