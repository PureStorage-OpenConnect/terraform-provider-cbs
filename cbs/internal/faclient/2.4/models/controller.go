...
func (m *Controller) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 ControllerAllOf1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.ControllerAllOf1 = aO1
...
func (m Controller) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.ControllerAllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *Controller) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with ControllerAllOf1
	if err := m.ControllerAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
