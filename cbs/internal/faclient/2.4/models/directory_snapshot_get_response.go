...
func (m *DirectorySnapshotGetResponse) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 DirectorySnapshotResponse
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.DirectorySnapshotResponse = aO1

	// AO2
	var aO2 DirectorySnapshotGetResponseAllOf2
	if err := swag.ReadJSON(raw, &aO2); err != nil {
		return err
	}
	m.DirectorySnapshotGetResponseAllOf2 = aO2
...
func (m DirectorySnapshotGetResponse) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.DirectorySnapshotResponse)
	if err != nil {
		return nil, err
	}
	_parts = append(_parts, aO1)

	aO2, err := swag.WriteJSON(m.DirectorySnapshotGetResponseAllOf2)
	if err != nil {
		return nil, err
	}
...
func (m *DirectorySnapshotGetResponse) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with DirectorySnapshotResponse
	if err := m.DirectorySnapshotResponse.Validate(formats); err != nil {
		res = append(res, err)
	}
	// validation for a type composition with DirectorySnapshotGetResponseAllOf2
	if err := m.DirectorySnapshotGetResponseAllOf2.Validate(formats); err != nil {
		res = append(res, err)
	}
...
func (m *DirectorySnapshotGetResponse) UnmarshalBinary(b []byte) error {
	var res DirectorySnapshotGetResponse
