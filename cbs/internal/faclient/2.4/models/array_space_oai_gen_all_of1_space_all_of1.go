...
func (m *ArraySpaceOAIGenAllOf1SpaceAllOf1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ArraySpaceOAIGenAllOf1SpaceAllOf1) validateReplication(formats strfmt.Registry) error {
...
func (m *ArraySpaceOAIGenAllOf1SpaceAllOf1) UnmarshalBinary(b []byte) error {
	var res ArraySpaceOAIGenAllOf1SpaceAllOf1
