...
func (m *DirectoryService) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 DirectoryServiceOAIGenAllOf1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.DirectoryServiceOAIGenAllOf1 = aO1
...
func (m DirectoryService) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.DirectoryServiceOAIGenAllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *DirectoryService) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with DirectoryServiceOAIGenAllOf1
	if err := m.DirectoryServiceOAIGenAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
