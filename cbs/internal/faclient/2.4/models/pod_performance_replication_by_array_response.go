...
func (m *PodPerformanceReplicationByArrayResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PodPerformanceReplicationByArrayResponse) validateItems(formats strfmt.Registry) error {
...
func (m *PodPerformanceReplicationByArrayResponse) validateTotal(formats strfmt.Registry) error {
...
func (m *PodPerformanceReplicationByArrayResponse) UnmarshalBinary(b []byte) error {
	var res PodPerformanceReplicationByArrayResponse
