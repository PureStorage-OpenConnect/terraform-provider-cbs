...
func (m *ConnectionGetResponse) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 ConnectionResponse
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.ConnectionResponse = aO1
...
func (m ConnectionGetResponse) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.ConnectionResponse)
	if err != nil {
		return nil, err
	}
...
func (m *ConnectionGetResponse) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with ConnectionResponse
	if err := m.ConnectionResponse.Validate(formats); err != nil {
		res = append(res, err)
	}
