...
func (m *TestResultGetResponse) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 TestResultResponse
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.TestResultResponse = aO1
...
func (m TestResultGetResponse) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.TestResultResponse)
	if err != nil {
		return nil, err
	}
...
func (m *TestResultGetResponse) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with TestResultResponse
	if err := m.TestResultResponse.Validate(formats); err != nil {
		res = append(res, err)
	}
