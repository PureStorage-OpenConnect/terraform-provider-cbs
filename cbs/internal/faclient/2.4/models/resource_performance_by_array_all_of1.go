...
func (m *ResourcePerformanceByArrayAllOf1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResourcePerformanceByArrayAllOf1) validateArray(formats strfmt.Registry) error {
...
func (m *ResourcePerformanceByArrayAllOf1) UnmarshalBinary(b []byte) error {
	var res ResourcePerformanceByArrayAllOf1
