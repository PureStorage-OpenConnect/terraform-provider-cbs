...
func (m *NetworkInterfacePerformanceGetResponseAllOf1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NetworkInterfacePerformanceGetResponseAllOf1) validateItems(formats strfmt.Registry) error {
...
func (m *NetworkInterfacePerformanceGetResponseAllOf1) validateTotal(formats strfmt.Registry) error {
...
func (m *NetworkInterfacePerformanceGetResponseAllOf1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *NetworkInterfacePerformanceGetResponseAllOf1) UnmarshalBinary(b []byte) error {
	var res NetworkInterfacePerformanceGetResponseAllOf1
