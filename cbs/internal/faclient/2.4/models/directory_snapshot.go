...
func (m *DirectorySnapshot) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 DirectorySnapshotOAIGenAllOf1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.DirectorySnapshotOAIGenAllOf1 = aO1
...
func (m DirectorySnapshot) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.DirectorySnapshotOAIGenAllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *DirectorySnapshot) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with DirectorySnapshotOAIGenAllOf1
	if err := m.DirectorySnapshotOAIGenAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
