...
func (m *ActiveDirectoryPostAllOf1) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateDirectoryServers(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateKerberosServers(formats); err != nil {
		res = append(res, err)
	}
...
func (m *ActiveDirectoryPostAllOf1) validateDirectoryServers(formats strfmt.Registry) error {

	if swag.IsZero(m.DirectoryServers) { // not required
		return nil
	}
...
func (m *ActiveDirectoryPostAllOf1) validateKerberosServers(formats strfmt.Registry) error {

	if swag.IsZero(m.KerberosServers) { // not required
		return nil
	}
