...
func (m *CertificateGetResponse) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 CertificateResponse
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.CertificateResponse = aO1
...
func (m CertificateGetResponse) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.CertificateResponse)
	if err != nil {
		return nil, err
	}
...
func (m *CertificateGetResponse) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with CertificateResponse
	if err := m.CertificateResponse.Validate(formats); err != nil {
		res = append(res, err)
	}
...
func (m *CertificateGetResponse) UnmarshalBinary(b []byte) error {
	var res CertificateGetResponse
