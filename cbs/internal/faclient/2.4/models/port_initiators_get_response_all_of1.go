...
func (m *PortInitiatorsGetResponseAllOf1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PortInitiatorsGetResponseAllOf1) validateItems(formats strfmt.Registry) error {
...
func (m *PortInitiatorsGetResponseAllOf1) UnmarshalBinary(b []byte) error {
	var res PortInitiatorsGetResponseAllOf1
