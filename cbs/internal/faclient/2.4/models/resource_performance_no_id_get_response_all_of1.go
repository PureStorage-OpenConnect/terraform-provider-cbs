...
func (m *ResourcePerformanceNoIDGetResponseAllOf1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResourcePerformanceNoIDGetResponseAllOf1) validateItems(formats strfmt.Registry) error {
...
func (m *ResourcePerformanceNoIDGetResponseAllOf1) validateTotal(formats strfmt.Registry) error {
...
func (m *ResourcePerformanceNoIDGetResponseAllOf1) UnmarshalBinary(b []byte) error {
	var res ResourcePerformanceNoIDGetResponseAllOf1
