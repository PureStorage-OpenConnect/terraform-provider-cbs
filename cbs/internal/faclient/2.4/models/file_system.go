...
func (m *FileSystem) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 FileSystemOAIGenAllOf1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.FileSystemOAIGenAllOf1 = aO1
...
func (m FileSystem) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.FileSystemOAIGenAllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *FileSystem) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with FileSystemOAIGenAllOf1
	if err := m.FileSystemOAIGenAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
