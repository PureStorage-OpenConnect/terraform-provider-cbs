...
func (m *VolumeGroup) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 VolumeGroupOAIGenAllOf1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.VolumeGroupOAIGenAllOf1 = aO1
...
func (m VolumeGroup) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.VolumeGroupOAIGenAllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *VolumeGroup) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with VolumeGroupOAIGenAllOf1
	if err := m.VolumeGroupOAIGenAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
