...
func (m *ResourceSpaceNoIDGetResponseAllOf1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResourceSpaceNoIDGetResponseAllOf1) validateItems(formats strfmt.Registry) error {
...
func (m *ResourceSpaceNoIDGetResponseAllOf1) UnmarshalBinary(b []byte) error {
	var res ResourceSpaceNoIDGetResponseAllOf1
