...
func (m *ResourcePerformanceNoIDByArray) UnmarshalJSON(raw []byte) error {
	// AO0
	var aO0 ResourcePerformanceNoID
	if err := swag.ReadJSON(raw, &aO0); err != nil {
		return err
	}
	m.ResourcePerformanceNoID = aO0

	// AO1
	var aO1 ResourcePerformanceNoIDByArrayAllOf1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.ResourcePerformanceNoIDByArrayAllOf1 = aO1
...
func (m ResourcePerformanceNoIDByArray) MarshalJSON() ([]byte, error) {
	...
	aO0, err := swag.WriteJSON(m.ResourcePerformanceNoID)
	if err != nil {
		return nil, err
	}
	_parts = append(_parts, aO0)

	aO1, err := swag.WriteJSON(m.ResourcePerformanceNoIDByArrayAllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *ResourcePerformanceNoIDByArray) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with ResourcePerformanceNoID
	if err := m.ResourcePerformanceNoID.Validate(formats); err != nil {
		res = append(res, err)
	}
	// validation for a type composition with ResourcePerformanceNoIDByArrayAllOf1
	if err := m.ResourcePerformanceNoIDByArrayAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
...
func (m *ResourcePerformanceNoIDByArray) UnmarshalBinary(b []byte) error {
	var res ResourcePerformanceNoIDByArray
