...
func (m *HostPerformanceBalanceGetResponse) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 HostPerformanceBalanceGetResponseAllOf1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.HostPerformanceBalanceGetResponseAllOf1 = aO1
...
func (m HostPerformanceBalanceGetResponse) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.HostPerformanceBalanceGetResponseAllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *HostPerformanceBalanceGetResponse) Validate(formats strfmt.Registry) error {
	var res []error
	...
	// validation for a type composition with HostPerformanceBalanceGetResponseAllOf1
	if err := m.HostPerformanceBalanceGetResponseAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
...
func (m *HostPerformanceBalanceGetResponse) UnmarshalBinary(b []byte) error {
	var res HostPerformanceBalanceGetResponse
