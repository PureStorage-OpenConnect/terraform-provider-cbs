...
func (m *ResourcePerformanceGetResponse) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 ResourcePerformanceGetResponseAllOf1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.ResourcePerformanceGetResponseAllOf1 = aO1
...
func (m ResourcePerformanceGetResponse) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.ResourcePerformanceGetResponseAllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *ResourcePerformanceGetResponse) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with ResourcePerformanceGetResponseAllOf1
	if err := m.ResourcePerformanceGetResponseAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
...
func (m *ResourcePerformanceGetResponse) UnmarshalBinary(b []byte) error {
	var res ResourcePerformanceGetResponse
