...
func (m AuditGetResponse) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.AuditResponse)
	if err != nil {
		return nil, err
	}
...
func (m *AuditGetResponse) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with AuditResponse
	if err := m.AuditResponse.Validate(formats); err != nil {
		res = append(res, err)
	}
