...
func (m *SubnetGetResponse) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 SubnetResponse
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.SubnetResponse = aO1
...
func (m SubnetGetResponse) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.SubnetResponse)
	if err != nil {
		return nil, err
	}
...
func (m *SubnetGetResponse) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with SubnetResponse
	if err := m.SubnetResponse.Validate(formats); err != nil {
		res = append(res, err)
	}
