...
func (m *DriveGetResponse) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 DriveGetResponseAllOf1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.DriveGetResponseAllOf1 = aO1
...
func (m DriveGetResponse) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.DriveGetResponseAllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *DriveGetResponse) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with DriveGetResponseAllOf1
	if err := m.DriveGetResponseAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
