...
func (m *RemoteProtectionGroupGetResponse) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 RemoteProtectionGroupResponse
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.RemoteProtectionGroupResponse = aO1
...
func (m RemoteProtectionGroupGetResponse) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.RemoteProtectionGroupResponse)
	if err != nil {
		return nil, err
	}
...
func (m *RemoteProtectionGroupGetResponse) Validate(formats strfmt.Registry) error {
	var res []error
	...
	// validation for a type composition with RemoteProtectionGroupResponse
	if err := m.RemoteProtectionGroupResponse.Validate(formats); err != nil {
		res = append(res, err)
	}
...
func (m *RemoteProtectionGroupGetResponse) UnmarshalBinary(b []byte) error {
	var res RemoteProtectionGroupGetResponse
